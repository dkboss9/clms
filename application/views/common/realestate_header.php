				...
				*************************************-->
				<header id="tg-dashboardheader" class="tg-dashboardheader tg-haslayout">
					...
					<div class="tg-rghtbox">
						<a class="tg-btn" href="<?php echo base_url("real_estate/verify_mobile.html");?>">
            ...
            ?>
				<div id="tg-verticalscrollbar" class="tg-verticalscrollbar">
					...
					<div class="tg-user">
						...
						<a class="tg-btnedit" href="<?php echo base_url("profile-setting.html");?>"><i class="icon-pencil"></i></a>
					</div>
					<nav id="tg-navdashboard" class="tg-navdashboard">
						<ul>
							<li class="tg-active">
								<a href="<?php echo base_url("real_estate");?>">
									<i class="icon-chart-bars"></i>
									<span> Insights</span>
								</a>
							</li>
							<li>
								<a href="<?php echo base_url("real_estate/profile-setting.html");?>">
									<i class="icon-cog"></i>
									<span>Profile Settings</span>
								</a>
							</li>
							<li>
								<a href="<?php echo base_url("real_estate/agents");?>">
									<i class="icon-user"></i>
									<span>Agents</span>
								</a>
							</li>
							<li>
								<a href="<?php echo base_url("real_estate/coupon-offers");?>">
									<i class="icon-star"></i>
									<span>Coupon</span>
								</a>
							</li>
							<li class="menu-item-has-children">
								...
								<ul class="sub-menu">
									<li><a href="<?php echo base_url("real_estate/my-ad.html");?>">All Properties</a></li>
									<li><a href="<?php echo base_url("real_estate/my-ad.html?featured=1");?>">Featured Properties</a></li>
									<li><a href="<?php echo base_url("real_estate/my-ad.html?status=active");?>">Active Properties</a></li>
									<li><a href="<?php echo base_url("real_estate/my-ad.html?status=inactive");?>">Inactive Properties</a></li>
								</ul>
							...
							<li class="menu-item-has-children">
								...
								<ul class="sub-menu">
									<li><a href="<?php echo base_url("real_estate/offermessages?status=received");?>">Offer Received</a></li>
									<li><a href="<?php echo base_url("real_estate/offermessages?status=sent");?>">Offer Sent</a></li>
								</ul>
							</li>
						
							<li>
								<a href="<?php echo base_url("real_estate/myad_payment"); ?>">
									<i class="icon-cart"></i>
									<span>Payments</span>
								</a>
							</li>
							...
							<li>
								<a href="<?php echo base_url("real_estate/privacy-setting.html");?>">
									<i class="icon-star"></i>
							...
							<li class="menu-item-has-children">
								...
								<ul class="sub-menu">
									<li><a href="<?php echo base_url("real_estate/invite-friend.html");?>">Invite Friends</a></li>
									<li><a href="<?php echo base_url("real_estate/referral_dashboard");?>">Referral Dashboard</a></li>
								</ul>
							</li>
							<li>
