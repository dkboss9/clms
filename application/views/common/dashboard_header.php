				...
				<div id="tg-verticalscrollbar" class="tg-verticalscrollbar">
					...
					<nav id="tg-navdashboard" class="tg-navdashboard">
						<ul>
							...
							<li>
								<a href="<?php echo base_url("coupon-offers");?>">
									<i class="icon-star"></i>
									<span>Coupon</span>
								</a>
							</li>
							...
							<li class="menu-item-has-children">
								...
								<ul class="sub-menu">
									<li><a href="<?php echo base_url("invite-friend.html");?>">Invite Friends</a></li>
									<li><a href="<?php echo base_url("referral_dashboard");?>">Referral Dashboard</a></li>
								</ul>
							</li>
							<li>
								<a href="<?php echo base_url("users/agent_request");?>">
