...
<head>
  ...
  <title><?php echo  $detail->title??$header_title; ?></title>
  <meta name="description" content="">
  <meta name="viewport" content="width=device-width, initial-scale=1">
   <?php 
  if(isset($detail)){ 
     $images = $this->home_model->get_post_images($detail->post_id);
  ?>
  <meta property="og:title" content="<?php echo $detail->title;?>">
  <meta property="og:description" content="<?php echo substr(strip_tags($detail->description), 0,300);?>">
            ...
            <div class="tg-navigationarea">
              <div class="container">
                <div class="row">
                  ...
                  <?php }else{
                    ?>
                      <a class="navbar-toggle collapsed link_top_search"  style="color: #fff;float:left;" href='<?php echo base_url(); ?>'>
