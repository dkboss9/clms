    ...
    <!--************************************
        ...
        *************************************-->
        <header id="tg-header" class="tg-header tg-haslayout">
          <div class="tg-topbar" style="background: #ffffff;">
<?php
if($this->uri->segment(1) == 'real_estate'){
$mobile_link = 'real_estate/';
$edit_link = 'real_estate/';
}else{
$mobile_link = 'adpost/';
$edit_link = '';
}
              ...
              <div class="container">
                <div class="row">
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                   <?php echo form_open($mobile_link.'/publish',array("id"=>"form_preview")); ?>
                   <?php echo form_close(); ?>
                   <?php if($this->session->userdata("bazar_userid") && $detail->posted_by == $this->session->userdata("bazar_userid")){?>
                   <div class="tg-adcontent" style="text-align:right;">

                   
                     <?php if($total_price > 0){ ?>
                        
                         <a href="<?php echo base_url($mobile_link."/payment/".$post_id);?>" name="publish" id="btn-post" class="link_user_action" style="border:#00cc67;">
                             <i class="fa fa-money" aria-hidden="true"></i> Pay <?php echo $total_price;?> AUD
                        </a> 
                        <?php 
                      }else{
                        ?>
                        <button  name="publish" id="btn-post" class="link_user_action" style="border:#00cc67;">
                          <i class="fa fa-plus-circle" aria-hidden="true"></i> Publish Ad 
                        </button> 
                        <?php
                      } ?>

                    <a class="link_user_action" style="" href="<?php echo base_url($edit_link."post-edit.html?make=".$detail->has_make."&price=".$detail->show_price."&post=".$detail->post_id."&form=".$detail->form_id."&offer=".$detail->offer_type."&job=".$detail->job_type);?>"> <span><i class="fa fa-pencil"></i> Edit </span></a>

                    <a class="link_user_action" href="<?php echo base_url($mobile_link."/deletepost/".$detail->post_id);?>" onClick="return confirmation();" style="background: #d9534f;"> <span><i class="fa fa-trash"></i> Delete </span></a>
