				...
				*************************************-->
				<header id="tg-dashboardheader" class="tg-dashboardheader tg-haslayout">
					...
					<div class="tg-rghtbox">
						<a class="tg-btn" href="<?php echo base_url("jobs/verify_mobile.html");?>">
				...
				<div id="tg-verticalscrollbar" class="tg-verticalscrollbar">
					...
					<nav id="tg-navdashboard" class="tg-navdashboard">
						<ul>
							...
							<li>
								<a href="<?php echo base_url("jobs/profile-setting.html");?>">
									<i class="icon-cog"></i>
									<span>Profile Settings</span>
								</a>
							</li>
							<!-- <li>
								<a href="<?php echo base_url("jobs/agents");?>">
									<i class="icon-user"></i>
									<span>Agents</span>
								</a>
							</li> -->
							<li>
								<a href="<?php echo base_url("jobs/coupon-offers");?>">
									<i class="icon-star"></i>
									<span>Coupon</span>
								</a>
							</li>
							<li class="menu-item-has-children">
								...
								<ul class="sub-menu">
									<li><a href="<?php echo base_url("jobs/my-ad.html");?>">All Jobs</a></li>
									<li><a href="<?php echo base_url("jobs/my-ad.html?featured=1");?>">Featured Jobs</a></li>
									<li><a href="<?php echo base_url("jobs/my-ad.html?status=active");?>">Active Jobs</a></li>
									<li><a href="<?php echo base_url("jobs/my-ad.html?status=inactive");?>">Inactive Jobs</a></li>
								</ul>
							...
							<li class="menu-item-has-children">
								...
								<ul class="sub-menu">
									<li><a href="<?php echo base_url("jobs/offermessages?status=received");?>">Offer Received</a></li>
									<li><a href="<?php echo base_url("jobs/offermessages?status=sent");?>">Offer Sent</a></li>
								</ul>
							</li>
						
							<li>
								<a href="<?php echo base_url("jobs/myad_payment"); ?>">
									<i class="icon-cart"></i>
									<span>Payments</span>
								</a>
							</li>
							...
							<li>
								<a href="<?php echo base_url("jobs/privacy-setting.html");?>">
									<i class="icon-star"></i>
							...
							<li class="menu-item-has-children">
								...
								<ul class="sub-menu">
									<li><a href="<?php echo base_url("jobs/invite-friend.html");?>">Invite Friends</a></li>
									<li><a href="<?php echo base_url("jobs/referral_dashboard");?>">Referral Dashboard</a></li>
								</ul>
							</li>
							<li>
