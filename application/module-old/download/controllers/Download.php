    ...
    function add() {
        if ($this->session->userdata("clms_front_userid") != "" && $this->usermodel->checkperm($this->module_code,"ADD")) {
            ...
            */
            ...
            $this->session->set_flashdata('success_message', 'download added successfully');
...
function edit() {
    if ($this->session->userdata("clms_front_userid") != "" && $this->usermodel->checkperm($this->module_code,"EDIT")) {
        if ($this->input->post('submit')) {
            ...
            $this->usermodel->insertUserlog($logs);
            $this->session->set_flashdata('success_message', 'download edited Successfully');
            redirect('dashboard/download');
        } else {
...
function delete() {
    if ($this->session->userdata("clms_front_userid") != "" && $this->usermodel->checkperm($this->module_code,"DELETE")) {
        ...
        $this->session->set_flashdata('success_message', 'download deleted successfully');
        redirect('dashboard/download');
    } else {
        $this->session->set_flashdata('error', 'Please login with your username and password');
        redirect('login', 'location');
