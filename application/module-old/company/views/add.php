...
<div class="form-group">
  ...
  <div class="col-sm-6">
    <input type="text" class="form-control" data-plugin-datepicker="" name="join_date" id="join_date" ="">
  </div>
</div>
<div class="form-group">
  <label class="col-sm-3 control-label" for="expiry_date">Expiry Date</label>
  <div class="col-sm-6">
    <input type="text" class="form-control" data-plugin-datepicker="" name="expiry_date" id="expiry_date" ="">
  </div>
</div>
