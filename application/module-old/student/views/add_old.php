...
<div class="row">
  <div class="col-lg-12">
    <section class="panel">
      ...
      <form id="form" method="post" action="<?php echo base_url("company/add");?>" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <div class="col-md-6">
        <input type="text" name="address" id="address" value="<?php echo set_value("address");?>" class="form-control"  required/>
      </div>
    </div>
