...
<div class="row" id="div_task" >
  <div class="col-lg-12">
    <section class="panel">
      <header class="panel-heading">
        ...
        <h2 class="panel-title">Client : Experience : [Edit]</h2>
      </header>
      <div class="panel-body">
        <form class="form-horizontal form-bordered" id="form_discussion" action="<?php echo current_url();?>" method="post" enctype='multipart/form-data'>
         ...
         <div class="form-group">
           ...
           <div class="col-md-6">
             <input type="text" name="experience" class="form-control required" value="<?php echo $exp->experience_name;?>">
           </div>
         </div>
         ...
         <div class="form-group">
           ...
           <div class="col-md-6">
            <input type="text" name="e_institution" class="form-control required" value="<?php echo $exp->institution_name;?>"> 
          </div>
        </div>
        ...
        <div class="form-group">
         ...
         <div class="col-md-6">
          <input type="text" name="e_position" class="form-control required" value="<?php echo $exp->position;?>"> 
        </div>
      </div>
      ...
      <div class="form-group">
       ...
       <div class="col-md-6">
        <input type="text" name="e_country" class="form-control required" value="<?php echo $exp->country;?>"> 
      </div>
    </div>
    ...
    <div class="form-group">
     ...
     <div class="col-md-6">
      <input type="text" name="e_commence_date" class="form-control required" value="<?php echo $exp->commence_date;?>">
    </div>
  </div>
  ...
  <div class="form-group">
   ...
   <div class="col-md-6">
    <input type="text" name="e_complete_date" class="form-control required" value="<?php echo $exp->complete_year;?>">
  </div>
</div>
...
<div class="form-group">
 ...
 <div class="col-md-6">
   <input type="checkbox" name="e_is_attached" value="1" <?php if($exp->doc_attached == '1') echo 'checked="checked"';?>>
 </div>
</div>
