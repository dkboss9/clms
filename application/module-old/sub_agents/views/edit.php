  ...
  <div class="col-lg-12">
    <section class="panel">
      <header class="panel-heading">
        ...
        <h2 class="panel-title">Sub agents : [Edit]</h2>
      </header>
      <div class="panel-body">
        <form class="form-horizontal form-bordered" id="form" action="<?php echo current_url();?>" method="post" enctype='multipart/form-data'>
          ...
          <div class="form-group">
            ...
            <label class="col-md-3 " for="is_percentage"> </label>
          ...
          <div class="form-group">
            ...
            <div class="col-md-3">
              <select name="staff" class="form-control" data-plugin-selectTwo id="staff" required>
            ...
            <label class="col-md-3 control-label" data-plugin-selectTwo for="action">  Action</label>
            <div class="col-md-3">
