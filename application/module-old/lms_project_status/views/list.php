        ...
        foreach ($status->result() as $row) {
          ...
          <tr class="gradeX">
           ...
           <td class="actions">
            ...
            <?php
            echo anchor('lms_project_status/edit/'.$row->status_id,'<span class="glyphicon glyphicon-edit"></span>').'&nbsp;'.$publish.'&nbsp;';
            if($row->status_id != 5)
             echo anchor('lms_project_status/delete/'.$row->status_id,'<span class="glyphicon glyphicon-trash"></span>',array('class'=>"link_delete"));
           ?>
         </td>
       </tr>
       <?php
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $('#addButton').bind('click',function(){window.location.assign("<?php echo base_url() ?>lms_project_status/add");})
    ...
    function cascade(action){
      ...
      if(ids.length == 0){
        ...
        $.ajax({
          url:"<?php echo base_url(); ?>lms_project_status/cascadeAction",
          type:"post",
          data:jsonData,
