  ...
  //echo $this->db->last_query();
    ...
    <div class="row">
      ...
      <div class="col-md-12" leadid="<?php echo $update->update_id;?>">
        <?php
        if($this->session->userdata("clms_front_user_group")){
    ...
    <form method="post"  action="<?php echo base_url("lms/add_update");?>">
      ...
      <div class="form-group">
        ...
        <div class="col-md-9">
          <select name="user" class="form-control mb-md" <?php if($this->session->userdata("clms_front_user_group") != '1' && $this->session->userdata("clms_front_user_group") != '7')  echo 'disabled=""';?>>
