  ...
  <div class="col-lg-12">
    <section class="panel">
      ...
      <div class="panel-body">
        <form class="form-horizontal form-bordered" id="form" action="<?php echo base_url("customer/add");?>" method="post" enctype='multipart/form-data'>
         <div class="form-group">
          <label class="col-md-3 control-label" for="customer_name">Customer Name</label>
          <div class="col-md-6">
            <input type="text" name="customer_name" value=""  class="form-control" id="customer_name" required>
        ...
        <div class="form-group">
          ...
          <div class="col-md-6">
            <input type="text" name="contact_number" value=""  class="form-control" id="contact_number" >
          </div>
        </div>
