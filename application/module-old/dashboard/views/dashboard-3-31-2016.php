...
function createDateRangeArray($strDateFrom,$strDateTo)
{
  ...
  <div class="row">
    ...
    <div class="row">
      ...
      //if($this->session->userdata("clms_front_user_group") == 1 || $this->session->userdata("clms_front_user_group") == 7)
       // $num1 = 1;
    //  else
      $num1 = $this->usermodel->getAssignedDashboard($this->session->userdata("clms_front_userid"),1);
      if($num1 > 0){
        ?>
        <div class="col-lg-6 col-md-12">
          <section class="panel">
            ...
            //if($this->session->userdata("clms_front_user_group") == 1 || $this->session->userdata("clms_front_user_group") == 7)
             // $num2 = 1;
           // else
            $num2 = $this->usermodel->getAssignedDashboard($this->session->userdata("clms_front_userid"),2);
            if($num2 > 0){
              ?>
              <div class="col-lg-6 col-md-12">
                <section class="panel">
            ...
            <div class="row">
              ...
              //if($this->session->userdata("clms_front_user_group") == 1 || $this->session->userdata("clms_front_user_group") == 7)
                //$num2 = 1;
            //  else
              $num2 = $this->usermodel->getAssignedDashboard($this->session->userdata("clms_front_userid"),3);
              if($num2 > 0){
                ?>
                <div class="col-md-6 col-lg-12 col-xl-6">
                  <section class="panel">
         ...
         // $num2 = 1;
       // else
         $num2 = $this->usermodel->getAssignedDashboard($this->session->userdata("clms_front_userid"),4);
         if($num2 > 0){
          ?>
          <div class="col-md-6 col-lg-12 col-xl-6">
            <div class="row">
     ...
     //   $num2 = 1;
     // else
       $num2 = $this->usermodel->getAssignedDashboard($this->session->userdata("clms_front_userid"),5);
       if($num2 > 0){
        ?>
        <div class="col-md-6 col-lg-12 col-xl-6">
          <section class="panel panel-transparent">
 ...
 // if($this->session->userdata("clms_front_user_group") == 1 || $this->session->userdata("clms_front_user_group") == 7)
  // $num2 = 1;
  //else
  $num2 = $this->usermodel->getAssignedDashboard($this->session->userdata("clms_front_userid"),6);
  if($num2 > 0){
    ?>
    <div class="col-md-6 col-lg-12 col-xl-6">
      <section class="panel panel-transparent">
...
//  $num2 = 1;
//else
$num2 = $this->usermodel->getAssignedDashboard($this->session->userdata("clms_front_userid"),7);
if($num2 > 0){
  ?>
  <div class="col-md-6 col-lg-12 col-xl-6">
    <div class="row">
...
<div class="row">
 ...
 <div class="col-xl-6 col-lg-6">
   <?php
   $num2 = $this->usermodel->getAssignedDashboard($this->session->userdata("clms_front_userid"),8);
   if($num2 > 0){
    ?>
    <section class="panel panel-transparent">
  ...
  <?php } ?>
  <?php
  $num2 = $this->usermodel->getAssignedDashboard($this->session->userdata("clms_front_userid"),13);
  if($num2 > 0){
    ?>
    <section class="panel">
      <header class="panel-heading">
    ...
    $(document).on('mousemove', '.ct-bar', function(event) {
      $tooltip.css({
        ...
        <?php
        $num2 = $this->usermodel->getAssignedDashboard($this->session->userdata("clms_front_userid"),9);
        if($num2 > 0){
          ?>
          <div class="col-lg-6 col-md-12">
            <section class="panel">
  ...
  //if($this->session->userdata("clms_front_user_group") == 1 || $this->session->userdata("clms_front_user_group") == 7)
   // $num2 = 1;
  //else
            $num2 = $this->usermodel->getAssignedDashboard($this->session->userdata("clms_front_userid"),10);
            if($num2 > 0){
              ?>
    ...
    //if($this->session->userdata("clms_front_user_group") == 1 || $this->session->userdata("clms_front_user_group") == 7)
     // $num2 = 1;
   // else
              $num2 = $this->usermodel->getAssignedDashboard($this->session->userdata("clms_front_userid"),11);
              if($num2 > 0){
                ?>
                <div class="col-lg-6 col-md-12">
                  <section class="panel">
