...
<div class="row">
  <div class="col-lg-12">
    <section class="panel">
      ...
      <form id="modifyuserpermission" method="post" action="<?php echo base_url(); ?>package/permission/<?php echo $this->uri->segment(3);?>">
         <div>
          <button type="button" class="btn btn-danger pull-right" onclick="window.location.assign('<?php echo base_url();?>index.php/package');return false;"> <span class="glyphicon glyphicon-floppy-remove"></span> Cancel </button>
