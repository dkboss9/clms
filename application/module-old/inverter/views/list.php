      ...
      foreach ($status->result() as $row) {
       ...
       <tr class="gradeX">
         ...
         <td class="actions">
          ...
          <a href="javascript:void(0);" onclick='return  confirmation_popup("Confirmation","Are you sure you want to delete the item? ","Cancel","Confirm","<?php echo base_url('inverter/delete/'.$row->threatre_id)?>");' class="" ><span class="glyphicon glyphicon-trash"></span></a>
        </td>
      </tr>
      <?php
    } ?>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    function cascade(action){
      ...
      confirmation_popup("Confirmation","Are you sure you want to proceed this Action? ","Cancel","Confirm","",action,"<?php echo base_url(); ?>inverter/cascadeAction");
