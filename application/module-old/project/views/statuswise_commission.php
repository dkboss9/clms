          ...
          <div class="col-md-6">
            <section class="panel">
              <header class="panel-heading">
                ...
                <h2 class="panel-title">Project Status - Bars Chart</h2>
              ...
              <div class="col-md-6">
                <section class="panel">
                  <header class="panel-heading">
                    ...
                    <h2 class="panel-title">Project_status - Pie Chart</h2>
    ...
    var chart = new Chartist.Bar('#ChartistStackedChart', {
      ...
      foreach ($users as $user) {
        ?>
        {
          ...
          data: [<?php        
          foreach ($status as $row) {
            echo intval($this->projectmodel->count_projectstatusCommission($user->userid,$row->status_id)).',';
          }
          ?>]
        },
        <?php
