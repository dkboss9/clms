        ...
        <label class="col-md-3 control-label">Appointment Date</label>
            <div class="col-md-3">
              <div class="input-group">
                ...
                <input type="text"  name="booking_date" id="booking_date" value="<?php echo date("d-m-Y",strtotime($result->booking_date))?>" class="form-control datepicker">
              </div>
            </div>
      </div>
      ...
      <label class="col-md-2 control-label">Mobile</label>
        ...
        <div class="col-md-3">
          <div class="input-group">
            ...
            <input type="text"  name="redminder_date" id="redminder_date" value="<?php echo date("d-m-Y",$result->reminder_date)?>" class="form-control datepicker">
          </div>
        </div>
      </div>
