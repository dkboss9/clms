...
<section class="panel">
  ...
  <table class="table table-bordered table-striped mb-none" id="datatable-default" style="width: 1700px;">
                          <thead>
                            <tr>
                              <th style="width:2%;"><input type="checkbox" name="all" id="checkall" ></th>
                              <th class="sorting_disabled" rowspan="1" colspan="1" aria-label="Actions" style="width: 10%;">Actions</th>
                              <th>Order Number</th>
                              <th>Customer Name</th>
                            ...
                            <tr class="gradeX">
                             ...
                             <td class="actions">
                              ...
                              <a class="  change_install" href="#" onclick='return  confirmation_popup("Confirmation","Do you really want to change it? ","Cancel","Confirm","<?php echo base_url("order/install/".$row->order_id);?>");'> 
                                <span class="glyphicon glyphicon-user" <?php echo !empty($install)  ? 'style="color:red;"':''; ?>></span>
                              </a>
                              <?php 
                            }else{
                              ?>
                              <a class="simple-ajax-popup-reminder  " href="<?php echo base_url("order/install/".$row->order_id);?>"> 
                                <span class="glyphicon glyphicon-user" <?php echo !empty($install) > 0 ? 'style="color:red;"':''; ?>></span>
                              </a>
                              <?php
                            } ?>
