  ...
  ?>
	<div class="row">
			<div class="col-sm-12 " style="margin-bottom:15px;text-align: right;">
				<button class="btn-success"  data-toggle="modal" data-target="#expiryDate">Invoice Expiry Date</button>
				<button class="btn-success"  data-toggle="modal" data-target="#exampleModal">Invoice Reminder</button>
			</div>
	</div>
	...
	<div class="panel-body">
		<div class="invoice">
			...
			<div class="text-right mr-lg">
				<a class="simple-ajax-popup123  btn-default btn" href="<?php echo base_url("order/invoice_reminder/".$result->order_id."?project=".$this->input->get("project")??0);?>" >Send a reminder</a>
				<a class="simple-ajax-popup123 btn-default btn" href="<?php echo base_url("order/payment/".$result->order_id."?project=".$this->input->get("project")??0);?>" >Record Payment</a>
				<a href="<?php echo base_url("order/preview_order/".$result->order_id."?project=".$this->input->get("project")??0);?>" class="btn btn-default">Download Invoice</a>
				  <a href="<?php echo base_url("order/mail_preview_invoice/".$result->order_id."?project=".$this->input->get("project")??0);?>" class="link_email simple-ajax-popup123 btn btn-default ">Submit Invoice</a>
