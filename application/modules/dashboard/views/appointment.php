...
<div class="row">
  ...
  <header class="panel-heading">
      ...
      <h2 class="panel-title">Appointment</h2>
    </header>
      ...
      <div class="tabs tabs-warning">
            <div class="row">
              ...
              <div class="col-sm-6" style="text-align:right;">
                <a class="mb-xs mt-xs mr-xs btn btn-success" href="<?php echo base_url("appointment/callendar");?>">Calendar</a>
              </div>
            </div>
              ...
              <tbody>
                ...
                foreach ($appointments->result() as $lead) {
                 ...
                 <tr class="gradeX">
                  ...
                  <td><?php echo date("h:i a",strtotime($lead->booking_time));?></td>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $('#addButton').bind('click',function(){window.location.assign("<?php echo base_url() ?>appointment/add?tab=1");})
