        ...
        foreach ($status->result() as $row) {
          ...
          <tr class="gradeX">
           ...
           <td class="actions">
            ...
            <?php echo anchor('task_status/edit/'.$row->status_id,'<span class="glyphicon glyphicon-edit"></span>').'&nbsp;'.$publish.'&nbsp;'.anchor('task_status/delete/'.$row->status_id,'<span class="glyphicon glyphicon-trash"></span>',array('class'=>"link_delete"));?>
          </td>
        </tr>
        <?php
      } ?>
