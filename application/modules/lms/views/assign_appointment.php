  ...
  //echo $this->db->last_query();
	...
	<form method="post"  action="<?php echo base_url("appointment/add_consultant/".$result->lead_id);?>">
		...
		<div class="form-group">
				...
				<div class="col-md-9">
					<select name="consultant" id="consultant" class="form-control mb-md" data-plugin-selectTwo  required>
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				<div class="input-group">
					...
					<input type="text" id="booking_date" name="date" value="<?php echo $date; ?>" class="form-control datepicker" required>
				</div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-md-9">
				<div class="input-group">
					...
					<!-- <input type="text" data-plugin-timepicker="" value="<?php echo $result->booking_time;?>" name="time" class="form-control" data-plugin-options="{ &quot;showMeridian&quot;: false }"> -->
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				<select name="status" class="form-control mb-md" data-plugin-selectTwo >
					<option value="5">Book an appointment</option>
				</select>
			</div>
		</div>
