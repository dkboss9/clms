  ...
  <div class="col-xs-12">
    <section class="panel form-wizard" id="w4">
      <header class="panel-heading">
        ...
        <h2 class="panel-title">Consultant : [Edit]</h2>
      </header>
      <div class="panel-body">
        ...
        <form id="form" method="post" action="<?php echo base_url("employee/edit");?>" enctype="multipart/form-data" class="form-horizontal" novalidate="novalidate">
       ...
       <div class="form-group">
          <label class="col-md-2 control-label">Replace Image</label>
          <div class="col-md-3">
              ...
              <select name="employee_type" id="employee_type" class="form-control" required>
                ...
                <?php 
                  foreach($groups as $group){
                    ?>
                    <option value="<?php echo $group->groupid;?>" <?php echo $result->employee_type == $group->groupid ? 'selected':'';?>><?php echo $group->group_name;?></option>
                    <?php
                  }
                ?>
              </select>
...
<div id="w4-billing" class="tab-pane">
  <?php
  foreach($days as $day){
    $times = $this->employeemodel->get_service_time($result->employeeid,$day->day_id);
    if($times){
