      ...
      if($this->input->post("submit")){
        ...
        if( $this->input->post("paid") != ""){
          $insert_paid = array(
            ...
            "payment_method" => $this->input->post("payment_method"),
            "note" => $this->input->post("note"),
            "receipted_by" => $this->session->userdata("clms_front_userid"),
          );
          $this->db->insert("invoice_payment",$insert_paid);
...
function installer(){
  if ($this->session->userdata("clms_front_userid") != "" && $this->usermodel->checkperm("installer-order","VIEW")) {
...
function edit_activity($id){
  ...
  if($this->input->post("submit")){
    ...
    if($this->session->userdata("clms_front_userid") != $activity->user_id){
...
function submit_order($id){
  ...
  if ($query->num_rows() > 0) {
    ...
    $this->db->insert("student_notification",$notification);
  }
