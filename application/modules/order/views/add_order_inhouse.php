...
<label class="col-md-2 control-label" for="description">Date</label>
 <div class="col-md-3">
   <input type="text" id="date" name="date" class="form-control datepicker_job" value="<?php echo date("d/m/Y");?>" readonly>
 </div>
...
<div class="col-md-3">
 <input type="text" class="datepicker_job form-control required" value="" name="deadline" id="#deadline" readonly>
</div>
</div>
