        ...
        <div class="modal-content">
          <div class="tabs tabs-warning">
            <ul class="nav nav-tabs contact">
              <li class="active">
                <a aria-expanded="true" href="#add-contact" data-toggle="tab">Persional Info</a>
              </li>
              <li class="">
            ...
            <div class="tab-content">
              <div id="add-contact" class="tab-pane active">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                    <input type="text" name="phone" id="phone" value="" class="form-control  number" />
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="col-sm-12" style="overflow-x:auto;">
                    <table class="table table-bordered table-striped mb-none" id="">
                      ...
                      <tbody>
                        <tr>
                          <th><input type="text" name="qualifaction[]" class="form-control qualifaction" id="qualifaction" > </th>
                          <th><input type="text" name="institution[]" class="form-control institution" id="institution" > </th>
            ...
            for($k = 1950; $k <= date("Y");$k++){
              ...
              for($k = 1950; $k <= date("Y");$k++){
                ?>
                          ...
                          <th><input type="text" name="percentage[]" class="form-control percentage" id="percentage"></th>
                          <th><input type="checkbox" name="is_attached1" id="is_attached" class="is_attached"></th>
                        </tr>
                        <tr>
                          <th><input type="text" name="qualifaction[]" class="form-control qualifaction" id="qualifaction"> </th>
                          <th><input type="text" name="institution[]" class="form-control institution" id="institution"> </th>
  ...
  $("#toefl_yes").click(function(){
    ...
    $(document).on("change",".student_doc",function(){ 
      ...
      var sibling = $(this).siblings('input'); 
			...
			$.ajax({
				url: '<?php echo base_url("");?>student/upload_file/<?php echo $company->userid;?>', 
				dataType: 'text', 
				cache: false,
				contentType: false,
				processData: false,
