  ...
  <div class="col-lg-12">
    <section class="panel">
      ...
      <div class="panel-body">
        <form class="form-horizontal form-bordered" id="form" action="<?php echo base_url("company_email_template/edit");?>" method="post" enctype='multipart/form-data'>
          <?php if(isset($error)){ ?>
       ...
       <?php //if($this->mylibrary->getSiteEmail(73) == 1) {?>
       <div class="form-group">
