  ...
  <div class="col-lg-12">
    <section class="panel">
      <header class="panel-heading">
        ...
        <h2 class="panel-title">Doc Type : [Edit]</h2>
      </header>
      <div class="panel-body">
        <form class="form-horizontal form-bordered" id="form" action="<?php echo base_url("doc_type/edit");?>" method="post" enctype='multipart/form-data'>
          <?php if(isset($error)){ ?>
            ...
            <div class="col-md-6">
              <select name="category" id="category" class="form-control" required >
                ...
                foreach($categories as $cat){
                  ?>
                   <option value="<?php echo $cat->type_id;?>" <?php echo $result->visa_id == $cat->type_id ? 'selected':'';?>><?php echo $cat->type_name;?></option>
                  <?php 
                }
                ?>
              </select>
