		...
		<section class="panel">
			<div class="panel-body">
				...
				<div class="widget-toggle-expand mb-md">
					...
					if($this->session->userdata("clms_front_user_group") == 7 && $this->session->userdata("clms_front_userid") == $company_id){
						?>
						...
						<div id="edit" class="tab-pane active">
							...
							<form id="form" method="post" action="<?php echo current_url();?>" enctype="multipart/form-data" class="form-horizontal" novalidate="novalidate">
								...
								<fieldset>
									...
									<?php 
									//print_r($this->session->userdata("clms_front_userid"));
									// if($this->session->userdata("clms_front_userid") != $company_id){
										?>
