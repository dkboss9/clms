...
<section class="panel">
  <header class="panel-heading">
    ...
    <h2 class="panel-title">Contracter Status</h2>
  </header>
        ...
        <tr class="gradeX">
         ...
         <td class="actions">
           <?php 
            ...
            if($row->company_id > 0){
              echo anchor('installer_status/edit/'.$row->threatre_id,'<span class="glyphicon glyphicon-edit"></span>',array("class"=>""));
              ?>
              <a href="javascript:void(0);" onclick='return  confirmation("Confirmation","Are you sure you want to delete the item? ","Cancel","Confirm","<?php echo base_url("installer_status/delete/".$row->threatre_id)?>");' class="" ><span class="glyphicon glyphicon-trash"></span></a>
              <?php } ?>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $('#addButton').bind('click',function(){window.location.assign("<?php echo base_url() ?>installer_status/add");})
    ...
    function cascade(action){
      ...
      confirmation("Confirmation","Are you sure you want to proceed this Action? ","Cancel","Confirm","",action,"<?php echo base_url(); ?>installer_status/cascadeAction");
