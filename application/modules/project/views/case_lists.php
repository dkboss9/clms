              ...
              <tbody>
                ...
                foreach ($enrolls->result() as $row) {
                  ...
                  <tr class="gradeX">
                   ...
                   <td><a href="<?php echo base_url("project/case/$row->student_id/$row->enroll_id");?>"><?php echo $row->company_name;?></a></td>
                  ...
                  <td class="actions">
                    ...
                    <?php 
                    if($this->usermodel->checkperm_view($this->module_code,"EDIT"))
                    echo anchor('project/edit/'.$row->project_id.'?project=1','<span class="glyphicon glyphicon-edit"></span>');
                    echo '&nbsp;'.$publish.'&nbsp;';
                    if($this->usermodel->checkperm_view($this->module_code,"DELETE"))
                    echo anchor('project/delete/'.$row->project_id.'?project=1','<span class="glyphicon glyphicon-trash"></span>',array('class'=>"link_delete"));?>
                  </td>
                </tr>
                <?php
              } ?>
