<?php 
 ...
 $appointment_all = $this->appointmentmodel->listall(null,null,null,null,null,null,null,null,null,1,$student_id)->num_rows();
  ...
  <div class="col-md-12 col-lg-4 col-xl-4 lead_count_wrapper">
    ...
    <div class="lead_count_body">
      ...
      <div class="counter_wrapper">
        ...
        <div class="counter">
          <a href="<?php echo base_url("project/appointments/$student_id");?>"><?php echo $appointment_all;?></a>
        </div>
      </div>
    </div>
  </div>
