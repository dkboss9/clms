...
<?php $this->load->view("tab");?>
  ...
  <div class="col-md-1" id="post_img_profile">
      <?php if(file_exists("./uploads/document/".$result->picture) && $result->picture != ""){?>
     <img src="<?php echo SITE_URL."uploads/document/".$result->picture;?>" style="width:100%">
  <?php }else{
      ?>
      <img src="<?php echo SITE_URL."assets/images/!logged-user.jpg";?>" style="width:100%">
      <?php
  } ?>
  <a href="javascript:void(0);" id="link_remove_image" class="list-btn btn btn-primary">Remove</a>
  </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="user">How do you know about us?</label>
                                        <div class="col-md-3">
...
?>
  ...
  ?>
                                ...
                                <input type="hidden" name="student_id" value="<?php echo $result->userid;?>">
                        </form>
                    </div>
