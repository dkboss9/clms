  ...
  <div class="col-lg-12">
    <section class="panel">
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">
          <input type="text" name="name" value="<?php echo @$student->first_name;?>"  class="form-control required" id="" >
          <?php echo form_error("name");?>
        </div>
        <label class="col-md-3 control-label" for="inputDefault">Last Name</label>
        <div class="col-md-3">
          <input type="text" name="lname" value="<?php echo @$student->last_name;?>"  class="form-control required" id="" >
      ...
      <label class="col-md-2 control-label" for="email">Counsellor</label>
        ...
        <label class="col-md-3 control-label">Appointment Date</label>
          ...
          <div class="form-group">
            ...
            <div class="col-md-3">
              <input type="email" name="email" value="<?php echo @$student->email;?>"  class="form-control required" id="email" >
            </div>
          </div>
      ...
      <label class="col-md-2 control-label">Mobile</label>
        <div class="col-md-3 control-label">
          <div class="input-group">
            ...
            <input id="phone" name="phone" value="<?php echo @$student->phone;?>" data-plugin-masked-input=""  class="form-control number">
          </div>
        </div>
...
function get_appointmentTime(consultant,appointment_date){ alert("fdasf");
  $.ajax({
    method: "POST",
