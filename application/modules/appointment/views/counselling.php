    ...
    <section class="panel">
      ...
      <div class="panel-body">
        ...
        <div class="form-group">
          ...
          <label class="col-md-4 "><strong>Status :</strong> <span class="label" style="color:#fff;background:<?php echo $status->status_color;?>"><?php echo @$status->status_name;?></span> 
          <!-- <a class="simple-ajax-popup-reminder btn btn-success" href="<?php echo base_url("appointment/detail/".$result->lead_id);?>" style="float:right;">Update Status</a> -->
        </label>
        </div>
        <div class="form-group">
