  ...
  <div class="col-lg-12">
    <section class="panel">
      <header class="panel-heading">
        ...
        <h2 class="panel-title">Appointment : [Edit]</h2>
      </header>
     ...
     <label class="col-md-2 control-label" for="email">Counsellor</label>
        <div class="col-md-3">
          <select name="counseller" class="form-control" id="consultant">
        ...
        <label class="col-md-3 control-label">Appointment Date</label>
            <div class="col-md-3">
              <div class="input-group">
                ...
                <input type="text"  name="booking_date" id="booking_date" value="<?php echo $result->booking_date ? date("d-m-Y",strtotime($result->booking_date)):'';?>" class="form-control datepicker">
              </div>
            </div>
      </div>
      ...
      <label class="col-md-2 control-label">Mobile</label>
        ...
        <div class="col-md-3">
          <div class="input-group">
            ...
            <input type="text"  name="redminder_date" id="redminder_date" value="<?php echo $result->reminder_date > 0 ? date("d-m-Y",$result->reminder_date) : "";?>" class="form-control datepicker">
          </div>
        </div>
      </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-3">
              <div class="input-group">
                ...
                <input type="text" data-plugin-timepicker="" name="reminder_time" id="reminder_time" value="<?php echo $result->reminder_time;?>" class="form-control" data-plugin-options="{ &quot;showMeridian&quot;: false }">
              </div>
            </div>
            <label class="col-md-3 control-label" for="email">Note</label>
            <div class="col-md-3">
              <textarea name="note" class="form-control"><?php echo $result->note;?></textarea>
            </div>
          </div>
      <div class="form-group">
        ...
        <div class="col-md-6">
          ...
          <input type="hidden" name="student_id" value="<?php echo $result->student_id??0;?>">
          <input type="submit" name="submit" value="submit" class="mb-xs mt-xs mr-xs btn btn-success">
          <?php if($this->input->get("project") == 1 && isset($result->student_id) ){?>
