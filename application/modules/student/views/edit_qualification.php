...
<div class="row" id="div_task" >
  <div class="col-lg-12">
    <section class="panel">
      <header class="panel-heading">
        ...
        <h2 class="panel-title">Client : Qualification : [Edit]</h2>
      </header>
      <div class="panel-body">
        <form class="form-horizontal form-bordered" id="form_discussion" action="<?php echo current_url();?>" method="post" enctype='multipart/form-data'>
         ...
         <div class="form-group">
           ...
           <div class="col-md-6">
             <input type="text" name="qualifaction" class="form-control required" value="<?php echo $qdetail->qualification_name;?>">
           </div>
         </div>
         ...
         <div class="form-group">
           ...
           <div class="col-md-6">
            <input type="text" name="institution" class="form-control required" value="<?php echo $qdetail->institution_name;?>"> 
          </div>
        </div>
        ...
        <div class="form-group">
         ...
         <div class="col-md-6">
          <input type="text" name="country" class="form-control required" value="<?php echo $qdetail->country;?>"> 
        </div>
      </div>
      ...
      <div class="form-group">
       ...
       <div class="col-md-6">
        <input type="text" name="commence_date" class="form-control required" value="<?php echo $qdetail->commence_date;?>">
      </div>
    </div>
    ...
    <div class="form-group">
     ...
     <div class="col-md-6">
      <input type="text" name="complete_date" class="form-control required" value="<?php echo $qdetail->complete_year;?>">
    </div>
  </div>
  ...
  <div class="form-group">
   ...
   <div class="col-md-6">
    <input type="text" name="percent" class="form-control required" value="<?php echo $qdetail->percent;?>">
  </div>
</div>
...
<div class="form-group">
 ...
 <div class="col-md-6">
   <input type="checkbox" name="is_attached" value="1" <?php if($qdetail->doc_attached == '1') echo 'checked="checked"';?>>
 </div>
</div>
