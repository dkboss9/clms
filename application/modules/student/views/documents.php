...
<table class="table table-bordered table-striped mb-none" id="datatable-default">
  ...
  <tbody>
   ...
   foreach ($documents as $docs) {
     ...
     <td>
       <a href="<?php echo base_url("student/verify_document/".$docs->id.'/'.$result->id.'/'.$docs->is_verified);?>" class="link_verify">
         <?php 
  ...
  <div class="col-lg-12">
    <section class="panel">
      <header class="panel-heading">
        ...
        <h2 class="panel-title">Client : Documents : [New]</h2>
      </header>
      <div class="panel-body">
       ...
       <div class="form-group">
         <label class="col-md-3 control-label" for="discussion_description"> Description</label>
         <div class="col-md-6">
...
<script type="text/javascript">
  $(document).ready(function(){
   ...
   $(".link_verify").click(function(){
    if(!confirm('Are you to change the status?'))
      return false;
  });
 });
</script>