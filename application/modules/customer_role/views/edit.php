    ...
    <div class="col-md-10">
      ...
      <div>
        ...
        <div style="margin-top:10px;">
          <div class="col-md-12" >
            <?php $formAttribute = array('id' => 'editcustomerole');
             echo form_open('customer_role/edit',$formAttribute) ?>
            <div style="min-height: 70px;">
              <div class="page-header" data-spy="affix" data-offset-top="52" id="fix-page-header">
                <div>
                  <button class="btn btn-danger pull-right" type="button" onclick="window.location.assign('<?php echo base_url();?>index.php/customer_role/listall');"> <span class="glyphicon glyphicon-floppy-remove"></span> Cancel </button>
            ...
            <input type="hidden" name="id" id="id" value="<?php echo $result->role_id; ?>" />
            <div class="col-md-6">
              <table cellspacing="0" cellpadding="5" border="0" width="100%">
                <tr>
                    <td width="30%"><label for="role_name">Role </label></td>
                    <td><input type="text" name="role_name" id="role_name" value="<?php echo $result->role_name;?>" class="form-control input-sm" required /></td>
                </tr>
                <tr>
