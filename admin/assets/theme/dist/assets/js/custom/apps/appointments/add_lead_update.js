...
// Class definition
var KTUsersAddLeadUpdates = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_add_user');
    const form = element.querySelector('#kt_add_lead_update');
            ...
            form,
            {
                fields: {
                    ...
                    'time': {
                        validators: {
                            notEmpty: {
                                message: 'Reminder time address is required'
                            }
                        }
                    },
                    'weightage': {
