...
KTUtil.onDOMContentLoaded(function () {
  ...
  $(document).ready(function(){
     $(document).on("click",".link_addconsultant",function(){ 
        ...
        //alert(leadid);
            ...
            $.ajax({
                method: "POST",
                url: hostUrl + "appointment/add_consultant",
    ...
    var appointmentid = $(this).attr("leadid");

    //alert(leadid);

		$.ajax({
			method: "POST",
			url: hostUrl + "appointment/appointment_detail",
  ...
  $(".link_add_update").click(function(){
    ...
    //alert(leadid);
		...
		$.ajax({
			...
			data: { leadid: leadid, type:"appointment" }
		  })
			.done(function( msg ) {
			  $("#popup_lead_edit").html(msg);
              //KTUsersAddUser.init();
