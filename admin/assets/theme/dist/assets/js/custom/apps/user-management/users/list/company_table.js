                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        Swal.fire({
                            ...
                            $.ajax({
                                method: "POST",
                                url: hostUrl+'appointment/delete_appointment',
                                data: { leadid: leadid }
                              })
                                .done(function( msg ) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    Swal.fire({
                        ...
                        $.ajax({
                            method: "POST",
                            url: hostUrl+'appointment/delete_all_appointments',
                            data: { leadids: chk_leads }
                          })
                            .done(function( msg ) {
                             // alert( "Data Saved: " + msg );
                            });
...
$(document).on("click",".link_remove",function(){
  ...
  $(".link_astatus").click(function(){
    if(!confirm('Are you sure to change the status of appointment?'))
      return false;
      ...
      $.ajax({
        url:hostUrl+'appointment/change_status',
        type:"post",
        data:jsonData,
        success: function(msg){
          alert("The status of appointment has been changed successfully.");
          location.reload();
        }
      });
  });
