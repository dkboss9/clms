...
var KTAppCalendar = function () {
    ...
    const handleNewEvent = () => {
        // Update modal title
        modalTitle.innerText = "Add a New Appointment";
    ...
    const handleEditEvent = () => {
        ...
        $.ajax({
            type: "POST",
            url: hostUrl+'appointment/appointment_detail_calendar',
            data: "appointmentid="+appointmentid,
            success: function (msg) {
                modal.show();
              $("#div_edit_apppointment").html(msg);
              KTAppCalendar.init();
            }
          });
    ...
    const handleViewEvent = () => {
        ...
        $("#kt_modal_view_event_edit").attr("appointmentid",data.id);
...
$(document).on("change","#consultant",function(){
    var appointment_date = $('#kt_calendar_datepicker_start_date').val();
