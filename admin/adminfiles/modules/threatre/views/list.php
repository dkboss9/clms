...
<section class="panel">
  <header class="panel-heading">
    ...
    <h2 class="panel-title">Timeline List</h2>
  </header>
  ...
  <table class="table table-bordered table-striped mb-none" id="datatable-default">
    <thead>
      <tr>
        ...
        <th>Title</th>
        <th class="sorting_disabled" rowspan="1" colspan="1" aria-label="Actions" style="width:20%;">Actions</th>
      </tr>
    </thead>
    <tbody>
      <?php 
      foreach ($status->result() as $row) {
       ...
       <tr class="gradeX">
        ...
        <td class="actions">
         ...
         if($row->company_id > 0){
          echo anchor('threatre/edit/'.$row->threatre_id,'<span class="glyphicon glyphicon-edit"></span>',array("class"=>""));
          ?>
          <a href="javascript:void(0);" onclick='return  confirmation("Confirmation","Are you sure you want to delete the item? ","Cancel","Confirm","<?php echo base_url("threatre/delete/".$row->threatre_id)?>");' class="" ><span class="glyphicon glyphicon-trash"></span></a>
          <?php } ?>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $('#addButton').bind('click',function(){window.location.assign("<?php echo base_url() ?>threatre/add");})
  ...
  function cascade(action){
    ...
    confirmation("Confirmation","Are you sure you want to proceed this Action? ","Cancel","Confirm","",action,"<?php echo base_url(); ?>threatre/cascadeAction");
