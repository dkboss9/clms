  ...
  <div class="col-lg-12">
    <section class="panel">
      <header class="panel-heading">
        ...
        <h2 class="panel-title">Priority : [New]</h2>
      </header>
      <div class="panel-body">
        <form class="form-horizontal form-bordered" id="form" action="<?php echo base_url("priority/add");?>" method="post" enctype='multipart/form-data'>
          <?php if(isset($error)){ ?>
          <div class="alert alert-danger">
            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6">
              ...
              <a href="<?php echo base_url("priority");?>" class="mb-xs mt-xs mr-xs btn btn-danger">Back</a>
            </div>
          </div>
        </form>
      </div>
