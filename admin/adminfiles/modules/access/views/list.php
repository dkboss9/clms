  ...
  <section class="panel">
    <header class="panel-heading">
      ...
      <h2 class="panel-title">Access List</h2>
    </header>
    ...
    <table class="table table-bordered table-striped mb-none" id="datatable-default">
      ...
      <tbody>
        ...
        foreach ($access->result() as $acc) {
         ...
         ?>
         <tr class="gradeX">
           <td><input type="checkbox" class="checkone" value="<?php echo $acc->access_id; ?>" /></td>
           <td><?php echo $acc->access_name;?></td>

           <td class="actions">

            <?php echo $publish;
            //anchor('access/edit/'.$acc->access_id,'<span class="glyphicon glyphicon-edit"></span>').'&nbsp;'.'&nbsp;'.anchor('access/delete/'.$acc->access_id,'<span class="glyphicon glyphicon-trash"></span>',array('class'=>"link_delete"));?>
          </td>
        </tr>
        <?php
      } ?>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $('#addButton').bind('click',function(){window.location.assign("<?php echo base_url() ?>access/add");})
    ...
    function cascade(action){
      ...
      if(ids.length == 0){
        ...
        $.ajax({
          url:"<?php echo base_url(); ?>access/cascadeAction",
          type:"post",
          data:jsonData,
