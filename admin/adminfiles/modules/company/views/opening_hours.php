    ...
    <section class="panel">
			<div class="panel-body">
				...
				<div class="widget-toggle-expand mb-md">
					...
					if($this->session->userdata("usergroup") == 7 && $company->userid == $company->company_id){
						?>
        ...
        <ul class="nav nav-tabs">
            ...
            <div class="tab-content">
                <form class="form-horizontal form-bordered" id="form" action="<?php echo current_url();?>" method="post"
                    ...
                    <h4 class="mb-xlg"></h4>
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="fname">Summary Report Setting</label>
                        <div class="col-md-2">
                    ...
                    <h4 class="mb-xlg"></h4>
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="fname">Apointment Time Interval</label>
                        <div class="col-md-2">
                          <input type="radio" name="time_slot" id="half_hour" value="30" <?php echo $company->time_interval == 30 ? 'checked':''; ?> > 1/2 Hour
                        </div>
                        <div class="col-md-2">
                          <input type="radio" name="time_slot" id="one_hour" value="60"  <?php echo $company->time_interval == 60 ? 'checked':''; ?> > Hourly
                        </div>
                    </div>
