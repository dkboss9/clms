		...
		<section class="panel">
			<div class="panel-body">
				...
				<div class="widget-toggle-expand mb-md">
					...
					<?php
					if($this->session->userdata("usergroup") == 7){
						?>
						<hr class="dotted short">
						<a href="<?php echo base_url("upgrade/".$this->session->userdata("clms_userid"));?>" class="mb-xs mt-xs mr-xs btn btn-success">Upgrade Your Package</a>
						<?php } ?>
						<hr class="dotted short">
