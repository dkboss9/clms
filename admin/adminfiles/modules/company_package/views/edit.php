  ...
  <div class="col-lg-12">
    <section class="panel">
      <header class="panel-heading">
        ...
        <h2 class="panel-title">Subscription : [Edit]</h2>
      </header>
      <div class="panel-body">
        <form class="form-horizontal form-bordered" id="form" action="<?php echo base_url("company_package/edit");?>" method="post" enctype='multipart/form-data'>
          <?php if(isset($error)){ ?>
          <div class="alert alert-danger">
            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
          ...
          <div class="form-group">
            <label class="col-md-3 control-label">company_package Type</label>
            <div class="col-md-6">
              <div class="input-group">

                <?php 
                foreach ($types as $row) {
                  $num = $this->company_packagemodel->get_packageid($result->package_id,$row->type_id);
                  ?>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6">
            <textarea name="details" id="details" class="form-control"><?php echo $result->details;?></textarea>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6">
              <input type="hidden" name="company_package_id" value="<?php echo $result->package_id;?>">
              <input type="submit" name="submit" value="submit" class="mb-xs mt-xs mr-xs btn btn-success">
              <a href="<?php echo base_url("company_package");?>" class="mb-xs mt-xs mr-xs btn btn-danger">Back</a>
            </div>
          </div>
        </form>
      </div>
