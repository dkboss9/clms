        ...
        <div class="col-lg-12">
          <section class="panel">
            ...
            <div class="panel-body">
              <form class="form-horizontal form-bordered" id="form" action="javascript:addNote();" method="post"
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <textarea name="customer_note" class="form-control" id="customer_note"></textarea>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <textarea name="admin_note" class="form-control" id="admin_note"></textarea>
                  </div>
                </div>
  ...
  function addNote() {
    ...
    $.ajax({
      ...
      success: function (data) {
        var link = '<?php echo base_url("project/case")?>/' + student_id + '/' + enroll_id + '/' + 4;
