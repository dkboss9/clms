        ...
        <div class="case-list">
            <div class="row">
                ...
                <div class="mig-top-sec">
                    ...
                    <div class="adding">
                        <a href="<?php echo base_url("order/add?project=1&customer=$student_id")?>"><i class="fa fa-plus"></i>Add</a>
                        ...
                        <tbody>
                            ...
                            <tr class="gradeX">
                              ...
                              ?>
                                ...
                                <td><a
                                        href="<?php echo base_url("order/order_details/".$row->order_id."?project=1");?>"><?php echo $row->order_number;?></a>
                                </td>
