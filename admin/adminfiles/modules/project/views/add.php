  ...
  <div class="col-lg-12">
    <section class="panel">
      ...
      <div class="panel-body">
        ...
        <?php
        $style = $this->input->get("customer") ? 'style="display:none"' : '';
        ?>
        
        <div class="form-group">
          <label class="col-md-2 control-label" for="inputDefault" <?php echo $style;?>>Client</label>
          <div class="col-md-3" <?php echo $style;?>>
          ...
          <?php echo $this->input->get("customer") ? '' : ' <div class="col-md-1" ></div>';?>
...
<?php if(!$this->input->get('customer')){ ?>
    <select class="form-control required" name="student" id="student" data-plugin-selectTwo readonly>
      <option value="">Select</option>
      <?php
   ...
   <?php }else{ ?>
<input type="text" value="<?php echo @$student->first_name;?> <?php echo @$student->last_name;?>" readonly class="form-control">
<input type="hidden" name="student" value="<?php echo $this->input->get("customer");?>">
  <?php } ?>
 </div>
    ...
    <div class="col-md-8">
      ...
      <table style="width: 100%;" id="div_document">
       ...
       <tr>
        ...
        <td>  <select name="package[]" rel="1" id="package_desc_1" class="form-control package_name  doccuments" data-plugin-selectTwo>
          <option value="">Select</option>
          <?php 
...
<script type="text/javascript">
  ...
  $( ".end_date" ).datepicker({ format: 'dd-mm-yyyy',
   ...
   $(document.body).on('blur', '.package_price' ,function(){
    ...
    var total_fee = $("#total_fee").val();
    total_fee = total_fee == "" ? 0 : parseFloat(total_fee);
    var total = package_total+total_fee;
