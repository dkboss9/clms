          ...
          <div class="col-md-6">
            <section class="panel">
              <header class="panel-heading">
                ...
                <h2 class="panel-title">Sales Rep - Bars Chart</h2>
              ...
              <div class="col-md-6">
                <section class="panel">
                  <header class="panel-heading">
                    ...
                    <h2 class="panel-title">Sales Rep - Pie Chart</h2>
    ...
    var chart = new Chartist.Bar('#ChartistStackedChart', {
      ...
      foreach ($types as $type) {
        ?>
        {
          ...
          data: [<?php        
          foreach ($sales_rep as $row) {
            echo intval($this->projectmodel->count_projectSales($row->sales_rep,$type->type_id)).',';
          }
          ?>]
        },
        <?php
