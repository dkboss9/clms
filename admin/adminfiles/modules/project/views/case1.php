...
<div class="case-prog">
    <div class="row">
        <div class="col-md-8">
        <p><strong>Case started: </strong><span class="case_status"><?php echo $phase1->customer_note??"Inprogress";?></span></p>
        </div>
        <div class="col-md-4">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content case-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Case Started</h5>
            ...
            <form id="form_case" action="javascript:prcesscase();">
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-md-4 control-label case-label">Case Started</label>
                        <div class="col-md-6">
...
<script>
    ...
    function prcesscase(){
        ...
        $.ajax({
            ...
            type: "POST",
            data: {remark:remark,enroll_id:enroll_id,phase:1,send_email:send_email},
            success: function(data) { 
                var link = '<?php echo base_url("project/case")?>/'+student_id+'/'+enroll_id+'/'+2;
