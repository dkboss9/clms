      ...
      foreach ($starts->result() as $start) {
       ...
       <td><input type="checkbox" class="checkone" value="<?php echo $start->start_id; ?>" /></td>
         ...
         <td class="actions">
          ...
          <?php echo anchor('start/edit/'.$start->start_id,'<span class="glyphicon glyphicon-edit"></span>').'&nbsp;'.$publish.'&nbsp;'.anchor('start/delete/'.$start->start_id,'<span class="glyphicon glyphicon-trash"></span>',array('class'=>"link_delete"));?>
        </td>
      </tr>
      <?php
    } ?>
