            ...
            <table style="width: 100%;" id="div_document">
              ...
              foreach ($quote_inverters as $intverter) {
                ...
                <tr id="tr_<?php echo $i;?>">
                  ...
                  <td>  
                   <select name="package_desc[]"  id="package_desc_<?php echo $i;?>" rel="<?php echo $i;?>" class="form-control package_name"  required>
               ...
               <td> <input type="text" name="package_qty[]" value="<?php echo $intverter->quantity;?>" rel="<?php echo $i;?>" id="package_qty_<?php echo $i;?>" class="package_qty form-control" style="width:100px;margin-left:20px;"></td>
               ...
               <td>
                <input type="text" name="package_amount[]" value="<?php echo $intverter->amount;?>" rel="<?php echo $i;?>" id="package_amount_<?php echo $i;?>" class="package_amount form-control number" style="width:100px;margin-left:20px;">
              </td>
              <td><a href="javascript:void(0);" class="link_remove" rel="<?php echo $i;?>"> <i class="fa fa-trash" aria-hidden="true"></i></a></td>
            </tr>
            <?php
            $i++;
          }
...
<div class="form-group">
 ...
 <div class="col-md-8">
   <textarea name="note" id="note" class="form-control"><?php echo $result->note;?></textarea>
 </div>
</div>
...
<div class="col-md-1">
  <a href="javascript:void(0);" id="link_timeline"><i class="glyphicon glyphicon-plus"></i></a>
</div>
...
<div class="form-group" <?php if($company->chk_field1 == 0) echo 'style="display:none;"';?>> 
 ...
 <div class="col-md-8">
   <textarea name="testing" id="testing" class="form-control"><?php echo $result->testing;?></textarea>
 </div>
 <div class="col-md-2">
...
<div class="form-group" <?php if($company->chk_field2 == 0) echo 'style="display:none;"';?>>
 ...
 <div class="col-md-8">
   <textarea name="payment" id="payment" class="form-control"><?php echo $result->payment_terms;?></textarea>
 </div>
 <div class="col-md-2">
...
<label class="col-md-2 control-label" for="quote_from">Quote From</label>
  <div class="col-md-3">
   <select name="quote_from" id="quote_from" class="form-control" >
    <option value=""></option>
    <?php 
    foreach ($from as $row){
      ?>
...
<label class="col-md-2 control-label">Quote expiry date </label>
  <div class="col-md-3">
    <div class="input-group">
      ...
      <input type="text" data-plugin-datepicker="" value="<?php echo date("d/m/Y",$date);?>" name="date" class="form-control" required>
    </div>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-6">
    ...
    <input type="hidden" name="is_project" value="<?php if($this->input->get("project")) echo '1'; else echo '0'; ?>">
...
$("#add_more").click(function(){ 
  ...
  num = num + 1;
  var package_sel = '<select name="package_desc[]"  id="package_desc_'+num+'" class="form-control package_name" rel="'+num+'"  required>  <option value="">Select</option>';
  ...
  $("#div_document").append('<tr style="margin-top:10px;" id="tr_'+num+'">'+
   ...
   '<td> <input type="text" name="package_qty[]" value="1" rel="'+num+'" id="package_qty_'+num+'" class="package_qty form-control number" style="width:100px;margin-left:20px;"></td>'+
   ...
   ' <td><input type="text" name="package_amount[]" value="0" rel="'+num+'" id="package_amount_'+num+'" class="package_amount form-control number" style="width:100px;margin-left:20px;">'+
       '</td>'+
   '<td><a href="javascript:void(0);" class="link_remove" rel="'+num+'"> <i class="fa fa-trash" aria-hidden="true"></i></a></td></tr>');
});
