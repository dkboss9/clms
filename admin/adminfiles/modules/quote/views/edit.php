...
<div class="form-group">
  ...
  <div class="col-md-6">
    ...
    <input type="hidden" name="project" value="<?php if($this->input->get("project")) echo '1'; else echo '0'; ?>">
    ...
    <a href="<?php echo base_url("project/quote/".$result->customer_id);?>" class="mb-xs mt-xs mr-xs btn btn-danger">Back</a>
              <?php }else{ ?>
