...
<div id="custom-content" class="white-popup-block white-popup-block-md">
	<div class="row">
		<div class="col-md-12">
			<h5><?php echo $discussion->comment_description;?></h5>
		</div>
	</div>
	
	
	<?php 
	$updates = $this->ordermodel->get_discussionupdates($discussion->comment_id);
	...
	<div class="row">
		...
		<div class="col-md-12">
			<?php echo '<h6>'.$update->comment_description.'</h6>';?>
	...
	<form method="post" id="form_task"  action="<?php echo base_url("order/add_discussionupdate");?>" enctype='multipart/form-data'>
		...
		<div class="row mb-lg">
			<div class="col-sm-9 col-sm-offset-3">
				<input type="hidden" value="<?php echo $discussion->comment_id;?>" name="discussion_id">
