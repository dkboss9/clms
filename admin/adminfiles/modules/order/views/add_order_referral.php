        ...
        <form class="form-horizontal form-bordered" id="form" action="<?php echo base_url("order/add_order");?>" method="post" enctype='multipart/form-data'>
          ...
          <div id="div_new">
            <div class="form-group" >
             ...
             <div class="col-md-1">
               <?php 
               if ($this->session->userdata("clms_userid") != "" && $this->usermodel->checkperm1('CUSTOMER',"ADD")) {
                ?>
                ...
                if(isset($quote_inverters)){
                  foreach (@$quote_inverters as $intverter) {
                    ...
                    <tr id="tr_<?php echo $i;?>">
                     <td>
                       <?php 
                       if ($this->session->userdata("clms_userid") != "" && $this->usermodel->checkperm1('inverter',"ADD")) {
                        ?>
