          ...
          <table class="table table-bordered table-striped mb-none" id="datatable-default">
            ...
            <tbody>
              ...
              foreach ($installer->result() as $row) {
               ...
               ?>
               <tr class="gradeX">
                <td style="width:2%;"><input type="checkbox" class="checkone" value="<?php echo $row->id; ?>" group="<?php echo $this->session->userdata("usergroup");?>" status="<?php echo $row->install_status;?>" /></td>
