...
<!--  <label class="col-md-2 control-label" for="price">Due</label>
 <div class="col-md-3">
   <input type="text" name="due" value="<?php echo @$quote->price;?>"  id="due_amount" class="form-control" >
...
<div class="form-group">
 ...
 <div class="col-md-3">
   ...
   <label class="col-md-2 control-label div_payment_term" for="price" <?php if(@$quote->finance_option == '0') echo 'style="display:none;"'; ?>>Payment Terms</label>
   <div class="col-md-3 div_payment_term" <?php if(@$quote->finance_option == '0') echo 'style="display:none;"'; ?>>
