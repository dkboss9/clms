  ...
  <div class="col-xs-12">
    <section class="panel form-wizard" id="w4">
      <header class="panel-heading">
        ...
        <h2 class="panel-title">Employee : [Add]</h2>
      </header>
        ...
        <form id="form" method="post" action="<?php echo base_url("employee/add");?>" enctype="multipart/form-data" class="form-horizontal" novalidate="novalidate">
          ...
          <div class="form-group">
            ...
            <div class="col-md-3">
             ...
             <?php if(form_error("email")) echo '<label class="error">'.form_error("email").'</label>';?>
           </div>
         ...
         <div class="form-group">
              ...
              <select name="employee_type" id="employee_type" class="form-control" required>
                ...
                <?php 
                  foreach($groups as $group){
                    ?>
                    <option value="<?php echo $group->groupid;?>" <?php echo set_value("employee_type") == $group->groupid ? 'selected':'';?>><?php echo $group->group_name;?></option>
                    <?php
                  }
                ?>
              </select>
          ...
          <div class="col-md-1">
            <a href="javascript:void(0);" id="link_emp_type"><i class="glyphicon glyphicon-plus"></i></a>
          </div>
        </div>
...
<div id="w4-profile" class="tab-pane">
  <div class="form-group">
    ...
    <div class="col-md-3">
      <select name="level" id="level"  class="form-control">
        ...
        foreach($levels as $row){
          ?>
          <option value="<?php echo $row->level_id;?>" <?php echo set_value("level") == $row->level_id ? 'selected':'';?>><?php echo $row->level_title;?></option>
          <?php
        }
        ?>
      </select>
    ...
    <div class="col-md-1">
      <a href="javascript:void(0);" id="link_emp_level"><i class="glyphicon glyphicon-plus"></i></a>
    </div>
    <label class="col-md-2 control-label" for="department">Department</label>
    <div class="col-md-3">
        <select name="depatment" class="form-control" id="department" required>
            <option value="">Select</option>
            <?php
              foreach($departments as $department){
                ?>
                <option value="<?php echo $department->id; ?>" <?php echo set_value("depatment") == $department->id ? 'selected':'';?>><?php echo $department->name; ?></option>
                <?php
              }
            ?>
        </select>
    ...
    <div class="col-md-1">
      <a href="javascript:void(0);" id="link_department"><i class="glyphicon glyphicon-plus"></i></a>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-md-3">
      <select name="transport" id="transport"  class="form-control">
        ...
        foreach($transports as $row){
          ?>
          <option value="<?php echo $row->transport_id;?>" <?php echo set_value("transport") == $row->transport_id ? 'selected':'';?>><?php echo $row->transport_title;?></option>
          <?php
        }
        ?>
      </select>
    ...
    <div class="col-md-1">
      <a href="javascript:void(0);" id="link_transport"><i class="glyphicon glyphicon-plus"></i></a>
    </div>
    ...
    <div class="col-md-3">
     <select name="position" id="position"  class="form-control">
      ...
      foreach($positions as $row){
        ?>
        <option value="<?php echo $row->position_id;?>" <?php echo set_value("position") == $row->position_id ? 'selected':'';?>><?php echo $row->position_title;?></option>
        <?php
      }
      ?>
    </select>
  ...
  <div class="col-md-1">
      <a href="javascript:void(0);" id="link_position"><i class="glyphicon glyphicon-plus"></i></a>
    </div>
  <label class="col-md-2 control-label" for="wage">Wage</label>
  <div class="col-md-1">
    <input type="text" name="wage" id="wage" value="<?php echo set_value("wage");?>" class="form-control"  required />
  </div>
  <div class="col-md-2">
   <select name="type" id="emp_type"  class="form-control" required>
    ...
    foreach($types as $row){
      ?>
      <option value="<?php echo $row->type_id;?>" <?php echo set_value("type") == $row->type_id ? 'selected':'';?>><?php echo $row->type_title;?></option>
      <?php
    }
    ?>
  </select>
...
<div class="col-md-1">
      <a href="javascript:void(0);" id="link_wage"><i class="glyphicon glyphicon-plus"></i></a>
    </div>
</div>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $("#link_wage").click(function(){ 
      $("#form_wage_model").modal();
    });
    ...
    $("#link_transport").click(function(){ 
      $("#form_transport_model").modal();
    });


    $("#link_department").click(function(){ 
      $("#form_department_model").modal();
    });

    $("#link_emp_level").click(function(){ 
    $("#form_emplevel_model").modal();
  });

    $("#link_emp_type").click(function(){ 
    $("#form_empgroup_model").modal();
  });

  $("#form_group").validate();
  $("#form_emp_level").validate();

  $("#form_transport").validate();
