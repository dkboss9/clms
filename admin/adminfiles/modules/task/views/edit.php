      ...
      <div class="form-group">
        ...
        <div class="col-md-6">
          ...
          <select class="form-control" name="assign_to" required>
            ...
            foreach ($users as $user ) {
              ?>
              <option value="<?php echo $user->id;?>" <?php echo $result->assign_to == $user->id ? 'selected':'';?>><?php echo $user->first_name." ".$user->last_name;?></option>
              <?php
            }
            ?>
          </select>
          ...
          <select class="form-control" name="priority" required>
            ...
            <?php
                  foreach($priorities as $priority){
                    ?>
                      <option value="<?php echo $priority->id;?>" <?php if($result->priority == $priority->id) echo 'selected="selected"'; ?>><?php echo $priority->name;?></option>
                    <?php
                  }
                ?>
