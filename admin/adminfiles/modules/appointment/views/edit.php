<div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form id="kt_modal_add_user_form" class="form" action="<?php echo base_url("appointment/edit");?>" method="post">
                    <!--begin::Scroll-->
                        ...
                        <div class="row g-9 mb-7">
                            ...
                            <div class="col-md-6 fv-row fv-plugins-icon-container">
                                ...
                                <input type="text" name="name" class="form-control form-control-solid mb-3 mb-lg-0"
                                    placeholder="" value="<?php echo $result->lead_name;?>" id="firstname" autocomplete="off" />
                                <!--end::Input-->
                            ...
                            <div class="col-md-6 fv-row fv-plugins-icon-container">
                                ...
                                <input type="text" name="lname" class="form-control form-control-solid mb-3 mb-lg-0"
                                    placeholder="" value="<?php echo $result->lead_lname;?>" id="lastname" autocomplete="off"/>
                                <!--end::Input-->
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                            <!--end::Col-->
                            ...
                            <div class="row g-9 mb-7">
                                ...
                                <div class="col-md-6 fv-row fv-plugins-icon-container">
                                    ...
                                    <input type="text" name="booking_date"
                                        class="form-control form-control-solid mb-3 mb-lg-0" placeholder="" value="<?php echo $result->booking_date ? date("d-m-Y",strtotime($result->booking_date)):''?>"
                                        id="booking_date" />
                                    <!--end::Input-->
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                </div>
                        ...
                        <div class="row g-9 mb-7">
                            ...
                            <div class="col-md-6 fv-row fv-plugins-icon-container">
                                ...
                                <input type="email" name="email" class="form-control form-control-solid mb-3 mb-lg-0"
                                    placeholder="" value="<?php echo $result->email;?>" id="email" />
                                <!--end::Input-->
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                            <!--end::Col-->
            ...
            <?php 
                foreach($source as $row){
                  ?>
                   <option value="<?php echo $row->type_id;?>" <?php if($result->lead_source == $row->type_id) echo 'selected';?>><?php echo $row->type_name;?></option>
                  <?php
                }
            ?>
          </select>
             ...
             ?>
                            ...
                            <div class="col-md-6 fv-row fv-plugins-icon-container">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input id="phone" name="phone" value="<?php echo $result->phone_number;?>" data-plugin-masked-input=""  class="form-control form-control-solid mb-3 mb-lg-0">
                                <!--end::Input-->
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                            <!--end::Col-->
                        ...
                        <!--begin::Input group-->
                           ...
                           <div class="row g-9 mb-7">
                            ...
                            <div class="col-md-6 fv-row fv-plugins-icon-container">
                                ...
                                placeholder="" value="<?php echo $result->reminder_date ? date("d-m-Y",$result->reminder_date) : '';?>" id="date" />
                                <!--end::Input-->
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                            <!--end::Col-->
                            ...
                            <div class="col-md-6 fv-row fv-plugins-icon-container " >
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="reminder_time" value="<?php echo $result->reminder_time;?>"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--begin::Input-->
                            <textarea name="note"
                                class="form-control form-control-solid mb-3 mb-lg-0"><?php echo $result->note;?></textarea>
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                          ...
                          <div class="fv-row mb-7">
                            ...
                            <label class="form-check form-switch form-check-custom form-check-solid">
                                    <input class="form-check-input" type="checkbox" value="Approved" name="appointment_status"
                                        id="appointment_status" <?php echo $result->appointment_status == 'Approved' ? 'checked':'';?> />
                                    <span class="form-check-label fw-bold text-muted">Approved</span>
                                </label>
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
