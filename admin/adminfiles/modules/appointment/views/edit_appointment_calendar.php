 ...
 <div class="modal-content">
            <!--begin::Form-->
            <form class="form" action="<?php echo base_url("appointment/edit");?>" method="post" id="kt_modal_add_event_form">
                <!--begin::Modal header-->
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bolder" data-kt-calendar="title">Edit Appointment</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                        ...
                        <div class="col">
                            <div class="fv-row mb-9">
                                ...
                                <input class="form-control form-control-solid" name="booking_date"
                                    placeholder="Pick a start date" id="kt_calendar_datepicker_start_date" value="<?php echo $result->booking_date ? date("d-m-Y",strtotime($result->booking_date)):''?>" />
                                <!--end::Input-->
                            </div>
                        </div>
                        <div class="col" data-kt-calendar="datepicker">
                       ...
                       <div class="row row-cols-lg-2 g-10">
                        <div class="col">
                            <div class="fv-row mb-9">
                                ...
                                placeholder="" value="<?php echo $result->reminder_date ? date("d-m-Y",$result->reminder_date) : '';?>" id="kt_calendar_datepicker_end_date" />
                                <!--end::Input-->
                            </div>
                        </div>
                        <div class="col" data-kt-calendar="datepicker">
