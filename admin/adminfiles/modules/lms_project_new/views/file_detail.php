...
<div id="custom-content" class="white-popup-block white-popup-block-md">
	<div class="row">
		<div class="col-md-12">
			...
			<?php
			if($discussion->file_name != "" && file_exists("../uploads/lms_project/".$discussion->file_name)){
				?>
				<p> <a href="<?php echo SITE_URL."uploads/lms_project/".$discussion->file_name;?>" target="_blank"><?php echo 'Download File';?></a></p>
				<?php
			}
			?>
		</div>
	...
	<?php 
	$updates = $this->lms_projectmodel->get_fileupdates($discussion->file_id);
	...
	<form method="post" id="form_task"  action="<?php echo base_url("lms_project/add_fileupdate");?>" enctype='multipart/form-data'>
		...
		<div class="row mb-lg">
			<div class="col-sm-9 col-sm-offset-3">
				...
				<input type="hidden" value="<?php echo $discussion->file_title;?>" name="file_name">
