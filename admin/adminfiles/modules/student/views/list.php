		...
		<div class="toolbar" id="kt_toolbar">
			<div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
				...
				<div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
					<!--begin::Title-->
					<h1 class="text-dark fw-bolder my-1 fs-2">Client List</h1>
					<!--end::Title-->
					<!--begin::Breadcrumb-->
					<ul class="breadcrumb fw-bold fs-base my-1">
						...
						<li class="breadcrumb-item text-muted">Client Management</li>
				...
				<div class="d-flex align-items-center flex-nowrap text-nowrap py-1">
					<a href="#" class="btn bg-body btn-color-gray-700 btn-active-primary me-4">List view</a>
					<a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_create_project"
						id="kt_toolbar_primary_button">New Client</a>
				</div>
				<!--end::Actions-->
			</div>
		</div>
						...
						<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
							...
							<thead>
								...
								<tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
									...
									<th class="min-w-125px">Mail Chimp</th>
									<th>Is active</th>
								...
								<tr>
									...
									<td class="d-flex align-items-center">
										...
										<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
											<a href="<?php echo base_url("project/dashboard/".$row->id);?>">
												<div class="symbol-label">
												
														<?php if($row->picture && file_exists("../uploads/document/".$row->picture)){ ?>
																<img alt="Pic" src="<?php echo SITE_URL;?>uploads/document/<?php echo $row->picture;?>" class="w-100" />
																	<?php }else{ ?>
										...
										<div class="d-flex flex-column">
											<a href="<?php echo base_url("project/dashboard/".$row->id);?>"
												class="text-gray-800 text-hover-primary mb-1"><?php echo $row->first_name.' '.$row->last_name;?></a>
									...
									<td>
										...
										<br>
										<a href="<?php echo base_url("project/dashboard/".$row->id);?>">
											<div class="badge badge-light-success fw-bolder">Profile</div>
										</a>
									</td>

									<td><?php echo $row->mailchimp == 0 ? '<a href="'.base_url("student/mailchimp/".$row->id).'">Subscribe </a>' : 'Yes';?>
									</td>
									...
									<td class="text-end">
										...
										<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
											...
											<div class="menu-item px-3">
												<a href="javascript:void();" studentid="<?php echo $row->id;?>"
											...
											<!--begin::Menu item-->
											<div class="menu-item px-3">
												<a href="<?php echo base_url("student/resend_activation/".$row->id)?>"
													class="menu-link px-3 link_email" style="font-size:10px;">Resend
													Activation</a>
											</div>
											<!--end::Menu item-->

											<div class="menu-item px-3">
												<a href="<?php echo base_url("student/delete/".$row->id);?>"
	...
	<script src="<?php echo base_url("assets/theme/dist/");?>assets/plugins/custom/datatables/datatables.bundle.js"></script>
		...
		<script src="<?php echo base_url("assets/theme/dist/");?>assets/js/custom/intro.js"></script>
