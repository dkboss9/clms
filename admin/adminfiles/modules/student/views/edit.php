...
<div class="row">
  <div class="col-xs-12">
    <section class="panel form-wizard" id="w4">
      <header class="panel-heading">
        ...
        <h2 class="panel-title">Client : [Edit]</h2>
      </header>
      <div class="panel-body">
        ...
        <form id="form" method="post" action="<?php echo base_url("student/edit");?>" enctype="multipart/form-data" class="form-horizontal" novalidate="novalidate">
          <div class="tab-content">
           ...
           <div class="form-group">
            ...
            <div class="col-md-3">
              <input type="text" name="mobile" id="mobile" value="<?php echo $result->mobile;?>" class="form-control number"  />
            </div>
         </div>
     ...
     <div class="col-md-3">
      <input type="text" data-plugin-datepicker="" name="dob" id="dob" value="<?php echo $result->dob;?>" class="form-control"  />
    </div>
  ...
  <div class="form-group">
   ...
   <div class="col-md-3">
    <input type="text"  name="passport_no" id="passport_no" value="<?php echo $result->passport_no;?>" class="form-control"  />
  </div>
  <label class="col-md-3 control-label" for="lname">Phone</label>
 <div class="col-md-3">
  <input type="text" name="phone" id="phone" value="<?php echo $result->phone;?>" class="form-control  number" />
</div>
</div>
 ...
 <div class="col-md-3">
  <select name="referral" id="user" class="form-control  " data-plugin-selectTwo>
    ...
    foreach($users as $user){
      ?>
      <option value="<?php echo $user->id;?>" <?php if($user->id == $result->referral) echo 'selected="selected"'; ?>><?php echo $user->first_name.' '.$user->last_name;?></option>
      <?php
    }
    ?>
  </select>
...
<label class="col-md-2 control-label" for="address">Address</label>
 <div class="col-md-3">
  <input type="text" name="address" id="address" value="<?php echo $result->address;?>" class="form-control"  />
</div>
</div>
...
<div class="form-group">
 ...
 <div class="col-md-3">
  <select name="is_married" class="form-control " data-plugin-selectTwo>
   <option value="">Select</option>
   <option value="Single" <?php if($result->is_married == "Single") echo 'selected="selected"';?>>Single</option>
   <option value="Married" <?php if($result->is_married == "Married") echo 'selected="selected"';?>>Married</option>
 </select>
</div>
</div>
  ...
  <div class="col-md-3">
    <select name="about_us" id="about_us" class="form-control " data-plugin-selectTwo>
      ...
      foreach($about_us as $row){
        ?>
        <option <?php if($row->threatre_id == $result->about_us) echo 'selected="selected"';?> value="<?php echo $row->threatre_id;?>"><?php echo $row->name;?></option>
        <?php
      }
      ?>
      ...
      <table class="table table-bordered table-striped mb-none" id="">
        ...
        <tbody>
          ...
          foreach ($qualifications as $qual) {
            ?>
            <tr>
             <th><input type="text" name="qualifaction[]" class="form-control " id="qualifaction" value="<?php echo $qual->qualification_name;?>"> </th>
             <th><input type="text" name="institution[]" class="form-control " id="institution" value="<?php echo $qual->institution_name;?>">  </th>
             <th>
              <select name="country[]" class="form-control" data-plugin-selectTwo style="width:200px;">
               <option value="">Select</option>
               <?php
               foreach ($countries as $row) {
                 ?>
                 <option value="<?php echo $row->country_name;?>" <?php if($row->country_name == $qual->country) echo 'selected="selected"';?> ><?php echo $row->country_name;?></option>
                 <?php
               }
               ?>
             </select>
           ...
           <th>
            <select name="commence_date[]" class="form-control " data-plugin-selectTwo> 
              <?php 
              for($k = 1950; $k <= date("Y");$k++){
                ?>
                <option value="<?php echo $k;?>" <?php if($qual->commence_date == $k) echo 'selected="selected"';?>>
                  <?php echo $k;?>
                </option>
                <?php
              }?>
          ...
          <th>
            <select name="complete_date[]" class="form-control " data-plugin-selectTwo> 
              ...
              for($k = 1950; $k <= date("Y");$k++){
                ?>
                <option value="<?php echo $k;?>" <?php if($qual->complete_year == $k) echo 'selected="selected"';?>>
                  <?php echo $k;?>
                </option>
                <?php
              }?>
          ...
          <th><input type="text" name="percentage[]" class="form-control " id="percentage" value="<?php echo $qual->percent;?>" ></th>
          <th><input type="checkbox" name="is_attached<?php echo $i;?>" id="is_attached" <?php if($qual->doc_attached == '1') echo 'checked="checked"';?>></th>
        </tr>
        <?php
        $i++;
      }
