    ...
    <div class="modal-body scroll-y m-5">
        ...
        <div class="stepper stepper-links d-flex flex-column" id="kt_modal_create_project_stepper">
            ...
            <div class="container">
                ...
                <!--end::Nav-->
                <!--begin::Form-->
                <form class="mx-auto w-100 mw-1000px pt-15 pb-10" action="<?php echo base_url("student/edit");?>"
                    enctype="multipart/form-data" novalidate="novalidate" id="kt_modal_create_project_form"
                    method="post">
                    <!--begin::Type-->
                    <div class="current" data-kt-stepper-element="content">
                        ...
                        <div class="w-100">
                            ...
                            <div class="fv-row mb-8">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-solid" name="fname" id="fname"
                                    placeholder="" value="<?php echo $result->first_name;?>" />
                            ...
                            <div class="fv-row mb-8">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="lname" id="lname" class="form-control form-control-solid"
                                    placeholder="" value="<?php echo $result->last_name;?>" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="fv-row mb-8">
                                ...
                                <input type="email" class="form-control form-control-solid" name="email" id="email"
                                    placeholder="" value="<?php echo $result->email;?>" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="fv-row mb-8">
                                ...
                                <input type="text" class="form-control form-control-solid" name="mobile" id="mobile"
                                    placeholder="" value="<?php echo $result->mobile;?>" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="fv-row mb-8">
                                ...
                                <div class="position-relative d-flex align-items-center">
                                    ...
                                    <input class="form-control form-control-solid ps-12" placeholder=""
                                        value="<?php echo $result->dob;?>" name="dob" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Wrapper-->
                            </div>
                            ...
                            <div class="fv-row mb-8">
                                ...
                                <input type="hidden" name="txt_profile_pic" id="txt_profile_pic"
                                    value="<?php echo $result->picture;?>">
                                <!--end::Input-->
                                <div class="col-md-1" id="post_img_profile">
                                    <img src="<?php echo SITE_URL."uploads/document/".$result->picture;?>"
                                        style="width:100%"><a href="javascript:void(0);" id="link_remove_image"
                                        class="list-btn btn btn-primary">Remove</a>
                            ...
                            <div class="fv-row mb-8">
                                ...
                                <input type="text" class="form-control form-control-solid" name="passport_no"
                                    id="passport_no" placeholder="" value="<?php echo $result->passport_no;?>" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="fv-row mb-8">
                                ...
                                <input type="text" class="form-control form-control-solid" name="phone" id="phone"
                                    placeholder="" value="<?php echo $result->phone;?>" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
    ...
    ?>
                            ...
                            <div class="fv-row mb-8">
                                ...
                                <input type="text" class="form-control form-control-solid" name="address" id="address"
                                    placeholder="" value="<?php echo $result->address;?>" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="fv-row mb-8">
                                ...
                                <select name="sex" id="sex" class="form-select form-select-solid" data-control="select2"
                                    data-hide-search="true" data-placeholder="Select...">
                                    <option value="">Select</option>
                                    <option value="Male" <?php if($result->sex == "Male") echo 'selected="selected"';?>>
                                        Male
                                    </option>
                                    <option value="Female"
      ...
      ?>
        ...
        ?>
                ...
                ?>
                                                ...
                                                <td>
                                                    <a href="javascript:void(0);" class="link_remove"
                                                        rel="<?php echo $i;?>" docid="<?php echo $docs->id;?>"><i
                    ...
                    <div data-kt-stepper-element="content">
                        ...
                        <div class="w-100">
                            ...
                            <div class="fv-row mb-15">
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <label class="form-check form-switch form-check-custom form-check-solid">
                                        <input class="form-check-input" type="checkbox" value="1" name="have_ielts"
                                            id="have_ielts"
                                            <?php if($result->ielts == '1') echo 'checked="checked"'; ?> />
                            ...
                            <div id="div_ielts" <?php echo $result->ielts == 1 ? '' : 'style="display:none;"';?>>
                                <!--begin::Input group-->
                                <div class="fv-row mb-8">
                                    <!--begin::Label-->
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="listening"
                                        id="listening" placeholder="" value="<?php echo $result->listening;?>">
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="fv-row mb-8">
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="writing"
                                        id="writing" placeholder="" value="<?php echo $result->writing;?>">
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="fv-row mb-8">
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="reading"
                                        id="reading" placeholder="" value="<?php echo $result->reading;?>">
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="fv-row mb-8">
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="speaking"
                                        id="speaking" placeholder="" value="<?php echo $result->speaking;?>">
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
                            ...
                            <div class="fv-row mb-15">
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <!--begin::Switch-->
                                    <label class="form-check form-switch form-check-custom form-check-solid">
                                        <input class="form-check-input" type="checkbox" value="1" name="have_toefl"
                                            id="have_toefl" <?php if($result->toefl == 1) echo 'checked="checked"';?> />
                            ...
                            <div id="div_toefl"  <?php echo $result->toefl == 1 ? '' : 'style="display:none;"';?>>
                                <!--begin::Input group-->
                                <div class="fv-row mb-8">
                                    <!--begin::Label-->
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="txt_toefl"
                                        id="txt_toefl" placeholder="" value="<?php echo $result->toefl_score;?>">
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
                            ...
                            <div class="fv-row mb-15">
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <!--begin::Switch-->
                                    <label class="form-check form-switch form-check-custom form-check-solid">
                                        <input class="form-check-input" type="checkbox" value="1" name="have_pte"
                                            id="have_pte" <?php if($result->pte == 1) echo 'checked="checked"';?> />
                                        <span class="form-check-label fw-bold text-muted">Yes</span>
                                    </label>
                                    <!--end::Switch-->
                                </div>
                            ...
                            <div id="div_pte" <?php echo $result->pte == 1 ? '' : 'style="display:none;"';?>>
                                <!--begin::Input group-->
                                <div class="fv-row mb-8">
                                    <!--begin::Label-->
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="txt_pte"
                                        id="txt_pte" placeholder="" value="<?php echo $result->pte_score;?>">
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
                            ...
                            <div class="fv-row mb-15">
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <!--begin::Switch-->
                                    <label class="form-check form-switch form-check-custom form-check-solid">
                                        <input class="form-check-input" type="checkbox" value="1" name="have_sat"
                                            id="have_sat" <?php if($result->sat == 1) echo 'checked="checked"';?> />
                                        <span class="form-check-label fw-bold text-muted">Yes</span>
                                    </label>
                                    <!--end::Switch-->
                                </div>
                            ...
                            <div id="div_sat" <?php echo $result->sat == 1 ? '' : 'style="display:none;"';?>>
                                <!--begin::Input group-->
                                <div class="fv-row mb-8">
                                    <!--begin::Label-->
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="txt_sat"
                                        id="txt_sat" placeholder="" value="<?php echo $result->sat_score;?>">
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
                            ...
                            <div class="fv-row mb-15">
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <!--begin::Switch-->
                                    <label class="form-check form-switch form-check-custom form-check-solid">
                                        <input class="form-check-input" type="checkbox" value="1" name="have_gre"
                                            id="have_gre" <?php if($result->gre == 1) echo 'checked="checked"';?> />
                                        <span class="form-check-label fw-bold text-muted">Yes</span>
                                    </label>
                                    <!--end::Switch-->
                                </div>
                            ...
                            <div id="div_gre" <?php echo $result->gre == 1 ? '' : 'style="display:none;"';?>>
                                <!--begin::Input group-->
                                <div class="fv-row mb-8">
                                    <!--begin::Label-->
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="txt_gre"
                                        id="txt_gre" placeholder="" value="<?php echo $result->gre_score;?>">
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
                            ...
                            <div class="fv-row mb-15">
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <!--begin::Switch-->
                                    <label class="form-check form-switch form-check-custom form-check-solid">
                                        <input class="form-check-input" type="checkbox" value="1" name="have_gmat"
                                            id="have_gmat" <?php if($result->gmat == 1) echo 'checked="checked"';?> />
                                        <span class="form-check-label fw-bold text-muted">Yes</span>
                                    </label>
                                    <!--end::Switch-->
                                </div>
                            ...
                            <div id="div_gmat" <?php echo $result->gmat == 1 ? '' : 'style="display:none;"';?>>
                                <!--begin::Input group-->
                                <div class="fv-row mb-8">
                                    <!--begin::Label-->
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="txt_gmat"
                                        id="txt_gmat" placeholder="" value="<?php echo $result->gmat_score;?>">
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
          ...
          foreach ($qualifications as $qual) {
            ?>
                                        <tr>
                                            <th><input type="text" name="qualifaction[]" class="form-control "
                                                    id="qualifaction" value="<?php echo $qual->qualification_name;?>">
                                            </th>
                                            <th><input type="text" name="institution[]" class="form-control "
                                                    id="institution" value="<?php echo $qual->institution_name;?>">
                                            </th>
                                            <th>
                                                <select name="country[]" class="form-control" data-plugin-selectTwo
                                                    style="width:200px;">
                                                    <option value="">Select</option>
                                                    <?php
              ...
              for($k = 1950; $k <= date("Y");$k++){
                ?>
                                            ...
                                            <th><input type="text" name="percentage[]" class="form-control "
                                                    id="percentage" value="<?php echo $qual->percent;?>"></th>
      ...
      for($j = $i; $j<=3; $j++){
        ?>
                                        <tr>
                                            <th><input type="text" name="qualifaction[]" class="form-control"> </th>
                                            <th><input type="text" name="institution[]" class="form-control"> </th>
                                            <th> <select name="country[]" class="form-control" data-plugin-selectTwo
                                                    style="width:200px;">
                                                    <option value="">Select</option>
                                                    <?php
           foreach ($countries as $row) {
          ...
          for($k = 1950; $k <= date("Y");$k++){
            ?>
                                            ...
                                            <th><input type="text" name="percentage[]" class="form-control"></th>
                                            <th><input type="checkbox" name="is_attached<?php echo $j;?>"></th>
                                        </tr>
                                        <?php
  }
  ?>
        ...
        foreach ($experiences as $exp) {
         ?>
         <tr>
           <th><input type="text" name="experience[]" class="form-control" value="<?php echo $exp->experience_name;?>"> </th>
           <th><input type="text" name="e_institution[]" class="form-control" value="<?php echo $exp->institution_name;?>">  </th>
           <th><input type="text" name="e_position[]" class="form-control" value="<?php echo $exp->position;?>">  </th>
           <th>
            <select name="e_country[]" class="form-control" style="width:200px;" data-plugin-selectTwo>
             <option value="">Select</option>
             <?php
             foreach ($countries as $row) {
               ?>
               <option value="<?php echo $row->country_name;?>" <?php if($exp->country == $row->country_name) echo 'selected="selected"';?>><?php echo $row->country_name;?></option>
               <?php
             }
             ?>
           </select>
         ...
         <th>
          <select name="e_commence_date[]" class="form-control " data-plugin-selectTwo> 
            <option value="">Select</option>
            <?php 
            for($k = 1950; $k <= date("Y");$k++){
              ?>
              <option value="<?php echo $k;?>" <?php if($k == $exp->commence_date) echo 'selected="selected"';?> >
                <?php echo $k;?>
              </option>
              <?php
            }?>
          ...
          <th>
           <select name="e_complete_date[]" class="form-control " data-plugin-selectTwo> 
            <option value="">Select</option>
            <?php 
            for($k = 1950; $k <= date("Y");$k++){
              ?>
              <option value="<?php echo $k;?>" <?php if($exp->complete_year == $k) echo 'selected="selected"';?>>
                <?php echo $k;?>
              </option>
              <?php
            }?>
        ...
        <th><input type="checkbox" name="e_is_attached<?php echo $i;?>" <?php if($exp->doc_attached == '1') echo 'checked="checked"';?>></th>
      </tr>
      <?php
      $i++;
    }
    for($j = $i; $j<=3; $j++){
     ...
     <tr>
       ...
       <th>
         <select name="e_country[]" class="form-control" data-plugin-selectTwo style="width:200px;">
           <option value="">Select</option>
           <?php
           foreach ($countries as $row) {
             ?>
      ...
      <th><input type="checkbox" name="e_is_attached<?php echo $j;?>"></th>
    </tr>
    <?php
  }
  ?>
