					...
					<div class="w-lg-500px p-10 p-lg-15 mx-auto">
						...
						<form class="form w-100" novalidate="novalidate" action="<?php echo current_url();?>" method="POST" id="kt_password_reset_form">
							...
							<div class="text-center mb-10">
								<!--begin::Title-->
								<h1 class="text-dark mb-3">Forgot Username ?</h1>
								<!--end::Title-->
								<!--begin::Link-->
								<div class="text-gray-400 fw-bold fs-4">Enter your email to reset your username.</div>
								<!--end::Link-->
							</div>
							<!--begin::Heading-->
							<!--begin::Input group-->
							<div class="fv-row mb-10">
								...
								<input class="form-control form-control-solid" type="email" placeholder="" name="email" required
									autocomplete="off" />
							</div>
									...
									elseif($this->input->get("success") == 1)
										...
										<p class="m-none text-weight-semibold h6">We have email your  username. Please check your email.	</p>
										</div>';
									else
										echo '';
