      ...
      <div class="d-flex flex-column flex-lg-row-auto bg-primary w-xl-600px positon-xl-relative">
        ...
        <div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
          ...
          <div class="d-flex flex-row-fluid flex-column text-center p-10 pt-lg-20">
            <!--begin::Logo-->
            <a href="<?php echo base_url();?>" class="py-9 pt-lg-20">
        ...
        <div class="d-flex flex-center flex-column flex-column-fluid">
          ...
          <div class="w-lg-500px p-10 p-lg-15 mx-auto">
            ...
            <form class="form w-100" novalidate="novalidate" id="sign_in_form"
              action="<?php echo base_url("login/checkusername");?>" method="POST">
              <!--begin::Heading-->
              ...
              <div class="fv-row mb-10">
                ...
                <div class="d-flex flex-stack mb-2">
                  ...
                  <!--end::Label-->
                  <!--begin::Link-->
                  <a href="<?php echo base_url("forgot-username");?>" class="link-primary fs-6 fw-bolder">Forgot
                    Username ?</a>
                  <!--end::Link-->
                </div>
                <!--end::Wrapper-->
              ...
              <div class="text-center">
                ...
                <div class="alert alert-success">
                  <strong>Well done!</strong> <?php echo $this->session->flashdata('success_message');?> <a href=""
                    class="alert-link">Thank you.</a>.
                </div>
                <?php } ?>
                <!--begin::Submit button-->
