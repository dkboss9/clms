...
<div class="right-wrapper pull-right">
  ...
  <section class="panel">
    <header class="panel-heading">
      ...
      <h2 class="panel-title">Newsletter List</h2>
    </header>
    ...
    <table class="table table-bordered table-striped mb-none" id="datatable-default">
      ...
      <tbody>
        <?php 
        foreach ($newsletter->result() as $start) {
         ...
         ?>
         <tr class="gradeX">
           <td><input type="checkbox" class="checkone" value="<?php echo $start->newsletter_id; ?>" /></td>
           <td><a href="<?php echo base_url("newsletter/detail/".$start->newsletter_id);?>"><?php echo $start->newsletter_title;?></a></td>
           <td><?php echo $start->newsletter_date;?></td>

           <td class="actions">

             <?php echo anchor('newsletter/edit/'.$start->newsletter_id,'<span class="glyphicon glyphicon-edit"></span>').'&nbsp;'.$publish.'&nbsp;'.anchor('newsletter/delete/'.$start->newsletter_id,'<span class="glyphicon glyphicon-trash"></span>',array('class'=>"link_delete"));?>
           </td>
         </tr>
         <?php
       } ?>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $('#addButton').bind('click',function(){window.location.assign("<?php echo base_url() ?>newsletter/add");})
    ...
    function cascade(action){
      ...
      if(ids.length == 0){
        ...
        $.ajax({
          url:"<?php echo base_url(); ?>newsletter/cascadeAction",
          type:"post",
          data:jsonData,
