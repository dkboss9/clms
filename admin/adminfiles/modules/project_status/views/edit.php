  ...
  <div class="col-lg-12">
    <section class="panel">
      ...
      <div class="panel-body">
        <form class="form-horizontal form-bordered" id="form" action="<?php echo base_url("project_status/edit");?>" method="post" enctype='multipart/form-data'>
          <?php if(isset($error)){ ?>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6">
              ...
              <a href="<?php echo base_url("project_status");?>" class="mb-xs mt-xs mr-xs btn btn-danger">Back</a>
            </div>
          </div>
        </form>
      </div>
