	...
	<div class="toolbar" id="kt_toolbar">
		<div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
			...
			<div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
				<!--begin::Title-->
				<h1 class="text-dark fw-bolder my-1 fs-2">Appointments List</h1>
				<!--end::Title-->
				<!--begin::Breadcrumb-->
				<ul class="breadcrumb fw-bold fs-base my-1">
					...
					<li class="breadcrumb-item text-dark">Appointments List</li>
				</ul>
				<!--end::Breadcrumb-->
			</div>
			<!--end::Info-->
				...
				<div class="card-header border-0 pt-6">
					...
					<div class="card-toolbar">
						...
						<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
							<!--begin::Filter-->
							<a href="<?php echo base_url("appointment/calendar");?>" class="btn btn-light-primary me-3">Calendar View</a>
							...
							<button type="button" class="btn btn-primary" data-bs-toggle="modal"
								...
								<!--end::Svg Icon-->Add Appointment</button>
							<!--end::Add user-->
						</div>
						<!--end::Toolbar-->
						<!--begin::Group actions-->
						...
						<?php $this->load->view("appointment/add_appointment");?>
	   ...
	   $publish = ($lead->status == 1 ? '<div class="badge badge-light-success fw-bolder">Active</div>' : '<div class="badge badge-light-danger fw-bolder">Inactive</div>');
          ...
          ?>
							<tr>
								...
								<td><?php echo $lead->booking_date  ?  date("d/m/Y",strtotime($lead->booking_date)) : '';?>
								</td>
								<td><?php echo $lead->booking_time  ? date("h:i a",strtotime($lead->booking_time)) : '';?>
								</td>
                  ...
                  ?>
								<td><?php echo !empty($handler)?$handler->first_name.' '.$handler->last_name:'<a class=" btn-default link_addconsultant"  data-bs-toggle="modal"
									data-bs-target="#kt_modal_add_user" leadid="'.$lead->lead_id.'"   href="javascript:void();"> <i class="fa fa-user-plus"></i></a>';?>
								</td>
								<td>
									<?php 
                    ...
                    if(count($updates)>0){
						?>
									<a class="simple-ajax-popup-reminder btn-default link_add_update"
										leadid="<?php echo $lead->lead_id;?>" href="javascript:void();"
										data-bs-toggle="modal" data-bs-target="#kt_modal_add_user"><img
											src="<?php echo base_url()."assets/theme/dist/assets/media/icons/history.png";?>"></a>
									<?php }else{ ?>
									<a class="simple-ajax-popup-reminder btn-default link_add_update"
										leadid="<?php echo $lead->lead_id;?>" href="javascript:void();"
										data-bs-toggle="modal" data-bs-target="#kt_modal_add_user">N/A</a>
									<?php   }?>
								</td>

								<td><a href="javascript:void()" class="link_astatus"
										status="<?php echo @$lead->appointment_status;?>"
										leadid="<?php echo $lead->lead_id;?>"><?php echo @$lead->appointment_status;?></a>
								</td>
								...
								<td class="text-end" leadid="<?php echo $lead->lead_id;?>">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
										...
										<!--begin::Menu item-->
										<div class="menu-item px-3">
											<a href="#" class="menu-link px-3 link_add_client"
												leadid="<?php echo $lead->lead_id;?>" data-bs-toggle="modal"
												data-bs-target="#kt_modal_create_project"
												id="kt_toolbar_primary_button">Add
												Client</a>
										</div>
										<div class="menu-item px-3">
										<a class="menu-link px-3 link_addconsultant"  data-bs-toggle="modal"
									data-bs-target="#kt_modal_add_user" leadid="<?php echo $lead->lead_id; ?>"   href="javascript:void();"> Add Consultant</a>
										</div>	
									<!--end::Menu item-->

										<div class="menu-item px-3">
											<a href="javascript:void();" leadid="<?php echo $lead->lead_id; ?>" class="menu-link px-3"
...
<script
	src="<?php echo base_url("assets/theme/dist/");?>assets/js/custom/apps/user-management/users/list/appointment_table.js">
</script>
<script
	src="<?php echo base_url("assets/theme/dist/");?>assets/js/custom/apps/user-management/users/list/export-users.js">
</script>
<script
	src="<?php echo base_url("assets/theme/dist/");?>assets/js/custom/apps/user-management/users/list/add_appointment.js">
</script>
...
<script src="<?php echo base_url("assets/theme/dist/");?>assets/js/custom/utilities/modals/create-project/documents.js">
</script>
