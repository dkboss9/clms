  ...
  <div class="modal-content">
  	...
  	<div class="modal-header" id="kt_modal_add_user_header">
  		<!--begin::Modal title-->
  		<h2 class="fw-bolder">Assign Appointment</h2>
  		<!--end::Modal title-->
  		<!--begin::Close-->
  ...
  //echo $this->db->last_query();
    foreach ($updates as $update) { ?>
        ...
        <a href="javascript:void();" class="link_edit" ><i class="fa fa-edit" style="float:right;"></i></a>
  		...
  		<hr>
  		<!--begin::Form-->
  		<form id="kt_assign_appointment" class="form"
  			action="<?php echo base_url("appointment/add_consultant/".$result->lead_id);?>"
  			...
  			<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true"
  				...
  				<?php
		if($result->booking_date == '0000-00-00')
			$date = '';
		else
			$date = date("d-m-Y",strtotime($result->booking_date));
		?>
  				...
  				<div class="fv-row mb-7">
  					...
  					<!--end::Label-->
  					<!--begin::Input-->
  					<select class="form-select form-select-solid fw-bolder" name="consultant"
  						id="consultant">
  				...
  				<div class="fv-row mb-7">
  					<!--begin::Label-->
  					<label class=" fw-bold fs-6 mb-2 required">Booking Date</label>
  					<!--end::Label-->
  					<!--begin::Input-->
  					<input type="text" name="date" class="form-control form-control-solid mb-3 mb-lg-0" placeholder=""
  						value="<?php echo $date; ?>" id="booking_date" />
  					<!--end::Input-->
  				</div>

  				<div class="fv-row mb-7">
  					<!--begin::Label-->
  					<label class=" fw-bold fs-6 mb-2 required">Booking Time</label>
  					<!--end::Label-->
  					<!--begin::Input-->

  					<select name="time" id="booking_time" class="form-select form-select-solid fw-bolder">
  						<option></option>
  ...
  <script
  	src="<?php echo base_url("assets/theme/dist/");?>assets/js/custom/apps/user-management/users/list/assign_appointment.js">
  </script>