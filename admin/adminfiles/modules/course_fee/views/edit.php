...
<div class="form-group">
            ...
            <div class="col-md-2">
              <input type="radio" name="bonus" class="radio-bonus" value="Yes" <?php echo $result->bonus == "Yes" ? "checked" : ""?>> Yes
              <input type="radio" name="bonus" class="radio-bonus" value="No" <?php echo $result->bonus == "No" ? "checked" : ""?>> No
            </div>
          </div>
          ...
          <div class="col-md-3"></div>
            <div class="col-md-6">
                <table class="table table-bordered table-striped mb-none tbl_bonus"  <?php echo $result->bonus == "Yes" ? "" : 'style="display: none;"'?>>
                  <thead>
                    <tr>
                  ...
                  <tbody id="tbody-bonus">
                    <?php 
                    foreach($course_fee_bonus as $bonus){
                      ?>
                       <tr>
                        <td><input type="number" min="1" name="txt_enrolled_per_intaked[]" value="<?php echo $bonus->enroll_per_intake;?>" class="form-control required"></td>
                        <td><input type="number" min="1" name="student_from[]" value="<?php echo $bonus->student_from;?>" class="form-control required"></td>
                        <td><input type="number" min="1" name="student_to[]" value="<?php echo $bonus->student_to;?>" class="form-control required"></td>
                        <td><input type="number" min="1" name="amount[]" value="<?php echo $bonus->amount;?>" class="form-control required"></td>
