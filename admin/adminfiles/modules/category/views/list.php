      ...
      <div>
        ...
        <table class="table table-striped table-hover">
          <tr>
            ...
            <th><a>Category Name</a> <a href=""><span class="glyphicon glyphicon-sort-by-attributes"></span></a></th>
            <th>Description</th>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#addButton').bind('click',function(){window.location.assign("<?php echo base_url() ?>index.php/category/add");})
    });
    ...
    function cascade(action){
		if(confirm('Are you sure to proceed this action?')){
			...
			$.ajax({
				url:"<?php echo base_url(); ?>index.php/category/cascadeAction",
				type:"post",
				data:jsonData,
