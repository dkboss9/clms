...
<head>
	...
	<link href="<?php echo base_url("assets/theme/dist/");?>assets/plugins/custom/datatables/datatables.bundle.css"
	...
	<div class="d-flex flex-column flex-root">
		...
		<div class="page d-flex flex-row flex-column-fluid">
			...
			<div id="kt_aside" class="aside aside-default aside-hoverable" data-kt-drawer="true"
				...
				<div class="aside-logo flex-column-auto pt-9 pb-5" id="kt_aside_logo">
					...
					<a href="<?php echo base_url();?>">
						<img alt="Logo" src="<?php echo SITE_URL."uploads/logo/".$row->config_value;?>"
							class="max-h-50px logo-default" style="height:40px;" />
						<img alt="Logo" src="<?php echo SITE_URL."uploads/logo/".$row->config_value;?>"
					...
					<div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-5 my-5 mt-lg-2 mb-lg-0"
						...
						<div class="menu-fit hover-scroll-y me-lg-n5 pe-lg-5" id="kt_aside_menu_wrapper"
							...
							<?php
									...
									$is_admin = $this->commonmodel->is_admin($user_id);
									$user_group_company_id = $this->session->userdata("user_group_companyid");

									if($is_admin){
										$menus = $this->commonmodel->get_adminmenu();
									}else{
									...
									foreach($menus as $menu){
										if($is_admin)
											$children_menus = $this->commonmodel->get_adminmenu($menu->menuid);
										else
							...
							<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
								<span class="menu-link">
									...
									<span class="menu-title"><?php echo $menu->menu_name;?></span>
								...
								<div class="menu-sub menu-sub-accordion menu-active-bg">
									...
									<div class="menu-item">
										<a class="menu-link" href="<?php echo base_url($child_menu->menu_link);?>">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
											<span class="menu-title"><?php echo $child_menu->menu_name;?></span>
										</a>
									</div>
									<?php }?>
								</div>
			...
			<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
						...
						<div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
							...
							<div class="d-flex align-items-stretch me-1">
								...
								<div id="kt_header_search" class="d-flex align-items-center w-100 w-lg-300px"
									...
									<form data-kt-search-element="form" class="d-none d-lg-block w-100 mb-5 mb-lg-0"
										autocomplete="off">
										<div class="position-relative d-flex align-items-center">
											...
											<!--begin::Input-->
											<input type="text"
												class="search-input form-control form-control-transparent ps-8"
												...
												<div class="scroll-y mh-200px mh-lg-350px">
													...
													<a href="#"
														...
														<div class="symbol symbol-40px me-4">
															<img src="<?php echo base_url("assets/theme/dist/");?>assets/media/avatars/300-6.jpg"
																alt="" />
														</div>
														<!--end::Symbol-->
														<!--begin::Title-->
													...
													<a href="#"
														...
														<!--begin::Symbol-->
														<div class="symbol symbol-40px me-4">
															<img src="<?php echo base_url("assets/theme/dist/");?>assets/media/avatars/300-2.jpg"
																alt="" />
														</div>
														<!--end::Symbol-->
														<!--begin::Title-->
													...
													<a href="#"
														...
														<!--begin::Symbol-->
														<div class="symbol symbol-40px me-4">
															<img src="<?php echo base_url("assets/theme/dist/");?>assets/media/avatars/300-9.jpg"
																alt="" />
														</div>
														<!--end::Symbol-->
														<!--begin::Title-->
													...
													<a href="#"
														...
														<!--begin::Symbol-->
														<div class="symbol symbol-40px me-4">
															<img src="<?php echo base_url("assets/theme/dist/");?>assets/media/avatars/300-14.jpg"
																alt="" />
														</div>
														<!--end::Symbol-->
														<!--begin::Title-->
													...
													<a href="#"
														...
														<!--begin::Symbol-->
														<div class="symbol symbol-40px me-4">
															<img src="<?php echo base_url("assets/theme/dist/");?>assets/media/avatars/300-11.jpg"
																alt="" />
														</div>
														<!--end::Symbol-->
														<!--begin::Title-->
														...
														<div class="symbol symbol-40px me-4">
															<span class="symbol-label bg-light">
																<img class="w-20px h-20px"
																	src="<?php echo base_url("assets/theme/dist/");?>assets/media/svg/brand-logos/volicity-9.svg"
																	alt="" />
															</span>
														</div>
														<!--end::Symbol-->
													...
													<a href="#"
														...
														<div class="symbol symbol-40px me-4">
															<span class="symbol-label bg-light">
																<img class="w-20px h-20px"
																	src="<?php echo base_url("assets/theme/dist/");?>assets/media/svg/brand-logos/tvit.svg"
																	alt="" />
															</span>
														</div>
														<!--end::Symbol-->
													...
													<a href="#"
														...
														<div class="symbol symbol-40px me-4">
															<span class="symbol-label bg-light">
																<img class="w-20px h-20px"
																	src="<?php echo base_url("assets/theme/dist/");?>assets/media/svg/misc/infography.svg"
																	alt="" />
															</span>
														</div>
														<!--end::Symbol-->
													...
													<a href="#"
														...
														<div class="symbol symbol-40px me-4">
															<span class="symbol-label bg-light">
																<img class="w-20px h-20px"
																	src="<?php echo base_url("assets/theme/dist/");?>assets/media/svg/brand-logos/leaf.svg"
																	alt="" />
															</span>
														</div>
														<!--end::Symbol-->
													...
													<a href="#"
														...
														<div class="symbol symbol-40px me-4">
															<span class="symbol-label bg-light">
																<img class="w-20px h-20px"
																	src="<?php echo base_url("assets/theme/dist/");?>assets/media/svg/brand-logos/tower.svg"
																	alt="" />
															</span>
														</div>
														<!--end::Symbol-->
							...
							<div class="d-flex align-items-stretch flex-shrink-0">
								...
								<!--begin::User-->
								<?php
										$profile = $this->usermodel->getuser($this->session->userdata("clms_userid"))->row();
									?>
								<div class="d-flex align-items-center ms-2 ms-lg-3" id="kt_header_user_menu_toggle">
									...
									<div class="cursor-pointer symbol symbol-35px symbol-lg-35px"
										data-kt-menu-trigger="click" data-kt-menu-attach="parent"
										data-kt-menu-placement="bottom-end">
										<?php if(file_exists('../assets/uploads/users/thumb/'.$profile->thumbnail) && $profile->thumbnail !=""){ ?>
										<img alt="Pic"
											src="<?php echo SITE_URL.'assets/uploads/users/thumb/'.$profile->thumbnail;?>">
										<?php }else{?>
										<img alt="Pic"
											src="<?php echo base_url("assets/theme/dist/");?>assets/media/avatars/300-1.jpg" />
										<?php }?>
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
											...
											<div class="menu-content d-flex align-items-center px-3">
												...
												<div class="d-flex flex-column">
													<div class="fw-bolder d-flex align-items-center fs-5">
														...
														<span
															class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2"><?php echo $this->session->userdata('groupname');?></span>
													</div>
													<a href="#"
														class="fw-bold text-muted text-hover-primary fs-7"><?php echo $profile->email;?></a>
												</div>
												<!--end::Username-->
											</div>
										</div>
										...
										<div class="menu-item px-5">
											<a href="<?php echo base_url("company/profile/".$this->session->userdata("clms_company"));?>"
										...
										<!--begin::Menu item-->
										<div class="menu-item px-5">
											<a href="<?php echo base_url("logout");?>" class="menu-link px-5">Sign
												Out</a>
										</div>
										<!--end::Menu item-->
										<!--begin::Menu separator-->
				...
				<script>
					var hostUrl = "<?php echo base_url();?>";</script>
