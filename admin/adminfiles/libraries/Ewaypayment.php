...
//define('EWAY_DEFAULT_GATEWAY_URL','https://www.eway.com.au/gateway/ManagedPaymentService/test/managedCreditCardPayment.asmx');

 //define( 'EWAY_DEFAULT_GATEWAY_URL', 'https://www.eway.com.au/gateway_cvn/xmltest/testpage.asp' );

 //define( 'EWAY_DEFAULT_CUSTOMER_ID', '91533096' );
 define( 'EWAY_DEFAULT_GATEWAY_URL', 'https://www.eway.com.au/gateway_cvn/xmlpayment.asp' );
 define( 'EWAY_DEFAULT_CUSTOMER_ID', '11668185' );
    ...
    function doPayment() {
        ...
        if( curl_errno( $ch ) == CURLE_OK ) {
            ...
            if( xml_get_error_code( $this->parser ) == XML_ERROR_NONE ) {
                ...
                if($this->xmlData['ewayTrxnStatus'] == "True"){
