...
class CI_Image_lib {
	...
	public function data() {
		if(!isset($this->dest_image))   return false;
		$xp = $this->explode_name($this->dest_image);
		return array(
			'type' => $this->mime_type,
			'orig_width' => $this->orig_width,
			'orig_height' => $this->orig_height,
			'new_width' => $this->width,
			'new_height' => $this->height,
			'src_path' => $this->source_folder,
			'dst_path' => $this->dest_folder,
			'src' => $this->full_src_path,
			'dst' => $this->full_dst_path,
			'src_file' => $this->source_image,
			'dst_file' => $xp['name'] . $this->thumb_marker . $xp['ext']
			);
	}
